...
test1<
  X extends void Function(X Function(int, {num n})),
  Y extends void Function(Y Function(int, {num n}))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<void Function(Never Function(int, {num n}))>>();
}

test2<
  X extends void Function(void Function(X, {X n})),
  Y extends void Function(void Function(Y, {Y n}))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<
      Exactly<void Function(void Function(Object?, {Object? n}))>
    >();
}
