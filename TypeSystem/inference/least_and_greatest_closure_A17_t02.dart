...
test1<
  X extends void Function<T extends X>(int, {num n}),
  Y extends void Function<T extends Y>(int, {num n})
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
...
test2<
  X extends void Function<T1 extends X, T2 extends num>(int, {num n}),
  Y extends void Function<T1 extends Y, T2 extends num>(int, {num n})
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<Function>>();
}
