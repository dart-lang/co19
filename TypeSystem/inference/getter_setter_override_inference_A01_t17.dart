...
/// superinterface. Test covariant variables.
/// @author sgrekhov22@gmail.com

import '../../Utils/static_type_helper.dart';

mixin class A {
  covariant num m1 = 3.14;
  covariant num m2 = 3.14;
  covariant num m3 = 3.14;
}
...
class C2 implements A {
  get m1 => 0;
  void set m1(v) {} // We need to implement a setter as well
  get m2 => 0; // And a getter
  void set m2(v) {
    v.expectStaticType<Exactly<num>>();
  }
  final m3 = 0;
