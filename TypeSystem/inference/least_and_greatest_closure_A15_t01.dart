...
test1<X extends X Function(int, {num n}), Y extends Y Function(int, {num n})>(
  X x,
  Y y,
) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<Object? Function(int, {num n})>>();
}

test2<X extends void Function(X, {X v}), Y extends void Function(Y, {Y v})>(
  X x,
  Y y,
) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<void Function(Never, {Never v})>>();
}
