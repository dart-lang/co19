...
///
/// @description Check that the type of a final field which which implements
/// both a setter and a getter is inferred to be the parameter type of the
/// combined member signature of said getter in the direct superinterfaces.
