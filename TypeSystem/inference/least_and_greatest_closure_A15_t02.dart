...
test1<
  X extends X Function<T>(int, {num n}),
  Y extends Y Function<T>(int, {num n})
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<Object? Function<T>(int, {num n})>>();
}

test2<
  X extends X Function<T extends num>(int, {num n}),
  Y extends Y Function<T extends num>(int, {num n})
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<Object? Function<T extends num>(int, {num n})>>();
}

test3<
  X extends void Function<T>(X, {X v}),
  Y extends void Function<T>(Y, {Y v})
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<void Function<T>(Never, {Never v})>>();
}

test4<
  X extends void Function<T extends num>(X, {X v}),
  Y extends void Function<T extends num>(Y, {Y v})
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<void Function<T extends num>(Never, {Never v})>>();
}
