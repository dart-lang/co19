...
class C1 implements A<num, int>, B {
  get m1 => 0;
  get m2 => 0;
...
class C2 implements B, A<num, int> {
  get m1 => 0;
  get m2 => 0;
  void set m1(_) {}
  void set m2(_) {}
...
mixin M1 implements A<num, int>, B {
  get m1 => 0;
  get m2 => 0;
  void set m1(_) {}
  void set m2(_) {}
...
mixin M2 implements B, A<num, int> {
  get m1 => 0;
  get m2 => 0;
  void set m1(_) {}
  void set m2(_) {}
...
mixin class MC1 implements A<num, int>, B {
  get m1 => 0;
  get m2 => 0;
  void set m1(_) {}
  void set m2(_) {}
...
mixin class MC2 implements B, A<num, int> {
  get m1 => 0;
  get m2 => 0;
  void set m1(_) {}
  void set m2(_) {}
...
enum E1 implements A<num, int>, B {
  e0;
...
enum E2 implements B, A<num, int> {
  e0;
