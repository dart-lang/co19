...
test1<
  X extends void Function(X Function<T>(int, [num])),
  Y extends void Function(Y Function<T>(int, [num]))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<void Function(Never Function<T>(int, [num]))>>();
}

test2<
  X extends void Function(X Function<T extends num>(int, [num])),
  Y extends void Function(Y Function<T extends num>(int, [num]))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<
      Exactly<void Function(Never Function<T extends num>(int, [num]))>
    >();
}

test3<
  X extends void Function(void Function<T>(X, [X])),
  Y extends void Function(void Function<T>(Y, [Y]))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<
      Exactly<void Function(void Function<T>(Object?, [Object?]))>
    >();
}

test4<
  X extends void Function(void Function<T extends num>(X, [X])),
  Y extends void Function(void Function<T extends num>(Y, [Y]))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<
      Exactly<void Function(void Function<T extends num>(Object?, [Object?]))>
    >();
}
