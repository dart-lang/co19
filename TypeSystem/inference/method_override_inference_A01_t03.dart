...
///
/// @description Checks that in case of extension types missing components of a
/// method signature are not inferred form a superinterface.
...
main() {
  ET(A()).m1.expectStaticType<Exactly<dynamic Function()>>();
  ET(A()).m2.expectStaticType<Exactly<void Function(dynamic)>>();
  ET(A()).m3.expectStaticType<Exactly<void Function([dynamic])>>();
  ET(A()).m4.expectStaticType<Exactly<void Function({dynamic v})>>();
  ET(A()).m5.expectStaticType<Exactly<void Function({required dynamic v})>>();
}
