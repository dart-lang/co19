...
test1<
  X extends void Function(void Function<T extends X>(int, [num])),
  Y extends void Function(void Function<T extends Y>(int, [num]))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
...
test2<
  X extends void Function(
    void Function<T1 extends X, T2 extends num>(int, [num]),
  ),
  Y extends void Function(
    void Function<T1 extends Y, T2 extends num>(int, [num]),
  )
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<void Function(Never)>>();
