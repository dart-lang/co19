...
class C1 implements A<int, num>, B {
  void set m1(v) {
...
class C2 implements B, A<int, num> {
  void set m1(v) {
    v.expectStaticType<Exactly<int>>();
  }
  void set m2(v) {
...
mixin M1 implements A<int, num>, B {
  void set m1(v) {
    v.expectStaticType<Exactly<int>>();
  }
  void set m2(v) {
...
mixin M2 implements B, A<int, num> {
  void set m1(v) {
    v.expectStaticType<Exactly<int>>();
  }
  void set m2(v) {
...
mixin class MC1 implements A<int, num>, B {
  void set m1(v) {
    v.expectStaticType<Exactly<int>>();
  }
  void set m2(v) {
...
mixin class MC2 implements B, A<int, num> {
  void set m1(v) {
    v.expectStaticType<Exactly<int>>();
  }
  void set m2(v) {
...
enum E1 implements A<int, num>, B {
  e0;
...
enum E2 implements B, A<int, num> {
  e0;
