...
test1<
  X extends void Function(X Function(int, [num])),
  Y extends void Function(Y Function(int, [num]))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<Exactly<void Function(Never Function(int, [num]))>>();
}

test2<
  X extends void Function(void Function(X, [X])),
  Y extends void Function(void Function(Y, [Y]))
>(X x, Y y) {
  var v = 1 > 2 ? x : y;
  v.expectStaticType<
      Exactly<void Function(void Function(Object?, [Object?]))>
    >();
}
