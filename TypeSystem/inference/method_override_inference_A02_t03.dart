...
class C1 extends A<num> implements B<String> {
  m1() => 0;
//^^
...
class C2 with A<num> implements B<String> {
  m1() => 0;
//^^
// [analyzer] unspecified
// [cfe] unspecified
...
mixin M on A<num> implements B<String> {
  m1() => '0';
//^^
// [analyzer] unspecified
// [cfe] unspecified
...
mixin class MC implements A<num>, B<String> {
  m1() => '0';
//^^
// [analyzer] unspecified
// [cfe] unspecified
...
enum E1 implements A<num>, B<String> {
  e0;
...
enum E2 with A<num> implements B<String> {
  e0;
