...
/// with an error.
///
/// @description Check that the type of a non-final field which implements both
/// a setter and a getter is inferred to be the parameter type of said setter in
/// the direct superinterface, not the type `dynamic`.
...
// [analyzer] unspecified
// [cfe] unspecified
  MA().m1.testNotDynamic;
//        ^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  MA().m2.testNotDynamic;
//        ^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  MC().m1.testNotDynamic;
//        ^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  MC().m2.testNotDynamic;
//        ^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
