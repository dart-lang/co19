...
class ClassMember1_t01 {
  static FutureOr<int> s = forgetType(t0Instance);
  FutureOr<int> m = forgetType(t0Instance);
  FutureOr<int> _p = forgetType(t0Instance);
  ...
  FutureOr<int> get getter => forgetType(_p);
  ...
  static FutureOr<int> get staticGetter => forgetType(t0Instance);
}
...
main() {
  ...
  ClassMember2_t01<FutureOr<int>> c2 = new ClassMember2_t01<FutureOr<int>>();
  c2 = new ClassMember2_t01<FutureOr<int>>.short(forgetType(t0Instance),
  forgetType(t0Instance));
  c2 = new ClassMember2_t01<FutureOr<int>>.named(forgetType(t0Instance));
