...
class ReturnValueTest {
  static (num, num, String?) staticTestMethod() => forgetType(t0Instance);

  (num, num, String?) testMethod() => forgetType(t0Instance);

  (num, num, String?) get testGetter => forgetType(t0Instance);
}
