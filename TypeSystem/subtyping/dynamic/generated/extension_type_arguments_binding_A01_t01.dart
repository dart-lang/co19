...
main() {
  ...
  namedArgumentsFunc2<V<num, Object>>(forgetType(t0Instance), t2: forgetType(t0Instance));

  // test generic class constructors
  ArgumentsBindingGen<V<num, Object>> instance2 =
      new ArgumentsBindingGen<V<num, Object>>(forgetType(t0Instance));
  instance2 = new ArgumentsBindingGen<V<num, Object>>.fNamed(forgetType(t0Instance),
      t2: forgetType(t0Instance));
  instance2 = new ArgumentsBindingGen<V<num, Object>>.named(forgetType(t0Instance),
      t2: forgetType(t0Instance));
