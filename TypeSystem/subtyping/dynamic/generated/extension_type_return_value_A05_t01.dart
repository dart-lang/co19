...
V1 returnValueFunc() => forgetType(t0Instance);

class ReturnValueTest {
  static V1 staticTestMethod() => forgetType(t0Instance);

  V1 testMethod() => forgetType(t0Instance);

  V1 get testGetter => forgetType(t0Instance);
}
...
main() {
  V1 returnValueLocalFunc() => forgetType(t0Instance);
  ...
  new ReturnValueGen<V1>().testMethod();
  new ReturnValueGen<V1>().testGetter;
}
