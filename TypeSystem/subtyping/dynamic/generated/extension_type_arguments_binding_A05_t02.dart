...
class ArgumentsBindingSuper1_t02 {
  ...
  ArgumentsBindingSuper1_t02(V1 value): m = value {}
  ArgumentsBindingSuper1_t02.named(V1 value, {V1 val2 = t1Default}): m = value {}
  ArgumentsBindingSuper1_t02.positional(V1 value, [V1 val2 = t1Default]): m = value {}
  ArgumentsBindingSuper1_t02.short(this.m);

  void superTest(V1 val) {}
  void superTestPositioned(V1 val, [V1 val2 = t1Default]) {}
  void superTestNamed(V1 val, {V1 val2 = t1Default}) {}
  V1 get superGetter => m;
...
main() {
  ...
  ArgumentsBinding2_t02<V1> c2 =
    new ArgumentsBinding2_t02<V1>(forgetType(t0Instance));
  c2 = new ArgumentsBinding2_t02<V1>.c2(t1Instance, forgetType(t0Instance));
  c2 = new ArgumentsBinding2_t02<V1>.c5(forgetType(t0Instance));
