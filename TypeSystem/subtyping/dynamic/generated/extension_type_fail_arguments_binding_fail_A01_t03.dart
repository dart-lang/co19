...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<V<int>>().superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<V<int>>().superTestNamed(forgetType(t0Instance), val2: forgetType(t1Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<V<int>>().superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<V<int>>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<V<int>>().superGetter;
  }, (e) => e is TypeError);

  new ArgumentsBinding2_t03<V<int>>().test();
}
