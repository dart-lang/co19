...
FutureOr<int> returnValueFunc() => forgetType(t0Instance);

class ReturnValueTest {
  static FutureOr<int> staticTestMethod() => forgetType(t0Instance);

  FutureOr<int> testMethod() => forgetType(t0Instance);

  FutureOr<int> get testGetter => forgetType(t0Instance);
}
...
main() {
  FutureOr<int> returnValueLocalFunc() => forgetType(t0Instance);
  ...
  new ReturnValueGen<FutureOr<int>>().testMethod();
  new ReturnValueGen<FutureOr<int>>().testGetter;
}
