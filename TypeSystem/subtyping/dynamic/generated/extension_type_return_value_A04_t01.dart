...
V1<num, Object> returnValueFunc() => forgetType(t0Instance);

class ReturnValueTest {
  static V1<num, Object> staticTestMethod() => forgetType(t0Instance);

  V1<num, Object> testMethod() => forgetType(t0Instance);

  V1<num, Object> get testGetter => forgetType(t0Instance);
}
...
main() {
  V1<num, Object> returnValueLocalFunc() => forgetType(t0Instance);
  ...
  new ReturnValueGen<V1<num, Object>>().testMethod();
  new ReturnValueGen<V1<num, Object>>().testGetter;
}
