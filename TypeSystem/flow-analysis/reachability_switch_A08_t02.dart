...
///
/// @note As of August 2025 there is no corresponding spec paragraph about
/// switch expressions or switch statements using patterns. Therefore the old
/// version of the spec is used.
///
/// @description Checks that if a variable is initialized in a `when` part of a
/// `case` statement then this variable is not definitely assigned.
/// @author sgrekhov22@gmail.com

main() {
  int i;
  switch (42) {
    case String _ when 0 > (i = 42):
  }
