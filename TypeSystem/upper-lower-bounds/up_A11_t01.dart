...
void f13a(FutureOr<Null> n) {
  // UP(Null, FutureOr<Null>) = FutureOr<Null>, because FutureOr<Null> is nullable
  var v = (1 > 2) ? null : n;
  v.expectStaticType<Exactly<FutureOr<Null>>>();
}

void f13b(Never? t1, FutureOr<Null> n) {
  // UP(Never?, FutureOr<Null>) = FutureOr<Null>, because FutureOr<Null> is nullable
  var v = (1 > 2) ? t1 : n;
  v.expectStaticType<Exactly<FutureOr<Null>>>();
}
...
void f14b(Never? t1, FutureOr<Never>? n) {
