 ...
 * @description Checks that when another exception is raised in a finally clause,
 * no catch clauses of that try statement are executed after that,
 * the current exception is replaced by the new one and control 
 * is transferred to the nearest enclosing exception handler.
 * @author rodionov
 * @reviewer iefremov
 */
