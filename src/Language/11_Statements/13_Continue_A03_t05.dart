 ...
 * @author rodionov
 * @reviewer iefremov
 * @needsreview spec v.008 is expected to clarify the use of continue statement
 * @note http://code.google.com/p/dart/issues/detail?id=1558 documents this failure
 */
