 ...
 * @description Checks that if the expression b evaluates to an object o that converts to the boolean true,
 * then the statement s1 is executed. Boolean true constant is tested as well as various comparison
 * expressions.
 * @author vasya
 * @reviewer rodionov
 * @reviewer iefremov
