 ...
 * @description Checks that common punctuation and arithmetic symbols are represented 
 * as a sequence of Unicode code points normalized to Unicode Normalization Form C.
 * @author vasya
 * @reviewer rodionov
 */
