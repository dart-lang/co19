 ...
 * is thrown.
 * @description  Checks that a NoSuchMethodError is thrown if the actual constructor has more
 * required parameters than the new expression.
 * @author kaigorodov
 * @reviewer rodionov
 */
...
test() {
  return new C();  // unspecified static warning - wrong number of arguments
}
main() {
