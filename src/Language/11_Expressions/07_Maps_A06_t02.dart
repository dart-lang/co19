...
main() {
  ...
  Expect.isFalse(identical(const {"key 1": 1, "key 2": 2}, const {"key 1": 1, "key 2": 3}));
  Expect.isFalse(identical(const {"": true}, const {"true": true}));
  Expect.isFalse(identical(const <String, String>{"key": "value", "value": "key"}, const {"key": "value", "value": "key"}));
  Expect.isFalse(identical(const <String, int>{"1": 1}, const <String, int>{"1": 1, "2": 2}));
}
