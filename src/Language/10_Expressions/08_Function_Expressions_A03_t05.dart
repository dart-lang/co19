 ...
 * of the form id(T1 a1, ..., Tn an, [Tn+1  xn+1 = d1, ... ,Tn+k xn+k = dk]) => e
 * where the type of e is int to a variable of a function type with boolean return type.
 * @static-warning
 * @author msyabro
 * @reviewer rodionov
 */
...
main() {
  foo f;
  checkTypeError( () {f = func(int x, int y, [double a, double b]) => 1;});
}
