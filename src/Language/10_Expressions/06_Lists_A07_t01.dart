...
main() {
  ...
  Expect.isTrue(const [1, 2, 1 + 2] === const [1, 2, 3]);
  Expect.isTrue(const <bool>[false] === const <bool>[false]);
  Expect.isTrue(const ["a", "b", "c"] === const ["a", "b", "c"]);
  Expect.isTrue(const [1, null, const C()] === const [1, null, const C()]);
