 ...
 * of the form T0 id(T1 a1, ..., Tn an, [Tn+1  xn+1 = d1, ..., Tn+k xn+k = dk]){s}
 * to a variable of a function type with an incompatible return type.
 * @static-warning
 * @author msyabro
 * @reviewer rodionov
 */
...
main() {
  foo f;
  checkTypeError( () {f = int id(int x, int y, [double a, double b]){return 0;};});
}
