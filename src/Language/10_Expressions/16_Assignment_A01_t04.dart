 ...
 * If there is no declaration d with name v in the lexical scope enclosing the
 ...
 * a instance variable declaration in class C is equivalent to the assignment this.v = e.
 * @author msyabro
 * @reviewer kaigorodov
 */
