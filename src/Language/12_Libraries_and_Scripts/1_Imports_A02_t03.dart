 ...
 * @description Checks that names imported into library B (which, in its turn, is imported into library A)
 * are not added to the scope of library A since they are not top level declarations of B. Empty prefix.
 * @compile-error
 * @author msyabro
 * @reviewer rodionov
 */
