 ...
 * @description Checks that it is a compile-time error when a Dart library
 * attempts to include itself as it contains a source directive.
 * @compile-error
 * @author msyabro
 * @reviewer rodionov
 */

#source("2_Includes_A01_t11.dart");

var topLevelDeclaration = 1;
