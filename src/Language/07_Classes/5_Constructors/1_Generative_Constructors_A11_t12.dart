 ...
 * @description Checks that 'this' is not accessible to initializers and an explicit access to a previously
 * initialized final field in an initializer results in a compile-time error.
 * @compile-error
 * @author rodionov
 * @reviewer kaigorodov
 */
