 ...
 * position.
 * @description Checks that a compile-time error is produced if there is no field
 * with the same name as initializing formal name (so, the initializing formal
 * doesn't introduce it's name into any scopes).
 * @compile-error
 * @author iefremov
