 ...
 * @description Checks that 'this' is not accessible on the right-hand side of an initialized instance variable 
 * declaration (e.g. a variable can't be initialized using another variable).
 * @compile-error
 * @author msyabro
 * @reviewer iefremov
 */
