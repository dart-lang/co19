 ...
 * @description Checks that function type t1 is still a subtype of function type t2 even if the names 
 * of its optional positional parameters do not match those of t2 as long as the types do.
 * @author iefremov
 * @reviewer rodionov
 */
