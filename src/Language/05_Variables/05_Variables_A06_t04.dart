 ...
 * It is a static warning if a library, static or local variable v is ﬁnal and v is not
 * initialized at its point of declaration.
 * @static-warning
 * @description Checks that it is a static warning when a final local variable is not
