 ...
 * @description Checks that an interface setter can override another setter it would otherwise inherit
 * without any static type warnings if its type is a subtype of the superinterface's setter's type.
 * @author rodionov
 * @reviewer kaigorodov
