 ...
 * @description Checks that a parameterized generic g1 is not a subtype of another parameterized generic g2 (same raw type)
 * if g1's only type parameter is not a subtype of g2's type parameter.
 * @author iefremov
 * @reviewer rodionov
 */
