 ...
 * libraries introduce the same type name (both via re-export of a third library) to the top 
 * level scope of A and A uses it in a static getter invocation expression.
 * @static-warning
 * @compile-error
 * @author rodionov
