 ...
 * @description Checks that it a compile-time error if two different libraries introduce
 * the same name (both via re-export of a third library) to the top level scope of A
