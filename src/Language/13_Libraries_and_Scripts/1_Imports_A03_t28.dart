 ...
 * if two different libraries introduce the same name (one of them via re-export) to the top level 
 * scope of A and A uses it as a type name reference in an instance creation expression.
 * @static-warning
 * @author rodionov
 */
