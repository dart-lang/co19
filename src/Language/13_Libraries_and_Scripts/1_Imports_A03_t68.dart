 ...
 * if the same library is imported twice with empty prefixes and introduces a name to the top level 
 * scope of A, which A uses as a type name reference in an instance creation expression.
 * @static-warning
 * @author rodionov
