 ...
 * @description Checks that it is a static warning and no dynamic type error in checked mode
 * if two different libraries introduce the same name N to the top level scope of A
 * and A uses it as a low type parameter bound because N is treated as dynamic.
 * @static-warning
 * @author kaigorodov
 */
