...
doTest([doc, tagToTest, templateInnerHTML, id, tagName, bodiesNum,
    footerIsNull, footerId, headerIsNull, headerId]) {
  ...
  if (footerId) {
    Expect.notEquals(footerId, table.tFoot.id,
  ...
  if (headerId) {
    Expect.notEquals(headerId, table.tHead.id,
