 ...
 * If false, the properties continue to inherit CSS styles
 */
...
main() {
  ...
  test(() {
    ...
    assert_false(s.resetStyleInheritance, 'Default value for ShadowRoot Object attribute resetStyleInheritance' +
