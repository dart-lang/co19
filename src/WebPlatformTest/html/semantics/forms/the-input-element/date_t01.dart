...
void main() {
  document.body.appendHtml(htmlEL);
      ...
      test(() {
        assert_equals(document.getElementById("valid").value, "2011-11-01", "valid");
        assert_equals(document.getElementById("too_small_value").value, "1970-01-31", "too_small_value");
        assert_equals(document.getElementById("too_large_value").value, "2099-01-31", "too_large_value");
      }, "The value attribute, if specified and not empty, must have a value that is a valid date string.");

      test(() {
        assert_equals(document.getElementById("valid").min, "2011-01-01", "valid");
        assert_equals(document.getElementById("invalid_min").min, "",  "invalid_min");
      }, "The min attribute, if specified, must have a value that is a valid date string.");

      test(() {
        assert_equals(document.getElementById("valid").max, "2011-12-31", "valid");
        assert_equals(document.getElementById("min_larger_than_max").max, "2099-01", "min_larger_than_max");
        assert_equals(document.getElementById("invalid_max").max, "", "invalid_max");
