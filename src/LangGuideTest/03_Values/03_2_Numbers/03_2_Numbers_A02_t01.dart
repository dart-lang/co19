 ...
 * as the input operands. If the operands are not of the same
...
main() {
  ...
  check(4.9406564584124654e-324, +0.0);
  check(4.9406564584124654e-324, -0.0);

  check(2.2250738585072009e-308, +0.0);
  check(2.2250738585072009e-308, -0.0);

  check(2.2250738585072014e-308, +0.0);
  check(2.2250738585072014e-308, -0.0);

  check(1.7976931348623157e308, +0.0);
  check(1.7976931348623157e308, -0.0);
}
