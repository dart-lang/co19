 ...
 * @description Checks that exiting the finally block by break aborts the unwinding of the stack.
 * @author pagolubev
 * @reviewer iefremov
 */
...
main() {
  try {
    ...
    Expect.fail("Caught exception aborted by break in finally clause.");
  }
}
