 ...
 * - A regular instance-method invocation, this.id(arg1, ..., argN), if the identifier resolved to an instance method 
 *   or if the identifier could not be resolved.
 ...
 * @description Expression evaluated as function-object invocation
 * @author msyabro
 * @reviewer akuznecov
 */

int func(var x, var y) {
  return x + y;
}
