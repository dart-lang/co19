    ...
    for (int j = 0; j < values.length; j++) {
      for (int k = 0; k < values.length; k++) {
        for (int l = 0; l < values.length; l++) {
          MutableRectangle r1=new MutableRectangle(values[i], values[j], values[k], values[l]);
          MutableRectangle r2=new MutableRectangle(values[k], values[l], values[i], values[j]);
    	  var res1 = (r1==r2);
    	  var res2 = (r2==r1);
    	  var res= (res1==res2);
    	  Expect.isTrue(res);
