...
void check(MutableRectangle r1, MutableRectangle r2, MutableRectangle expected) {
  MutableRectangle actual1=r1.intersection(r2);
  Expect.equals(expected, actual1, "r1=$r1, r2=$r2, expected=$expected, actual1=$actual1");
  MutableRectangle actual2=r2.intersection(r1);
...
main() {
  ...
  check(r,  new MutableRectangle(0.5, 0, 0.5, 1), new MutableRectangle(0.5, 0, 0.5, 1));
  check(r,  new MutableRectangle(-10, -5, 1, 1.5), null);
  check(r,  new MutableRectangle(0, 0, 1.1, 1), new MutableRectangle(0, 0, 1, 1));
  check(r,  new MutableRectangle(1.1, 1.1, 2, 2), null);
  check(r,  new MutableRectangle(1.0, 1.0, 2.1, 3.1), new MutableRectangle(1.0, 1.0, 0, 0));
}
