 ...
 * @description Checks that if one operand is a finite double and other is a positive
 * or negative infinity the result is a positive or negative infinity respectively.
 * @author pagolubev
 * @reviewer msyabro
 */
