 ...
 * Removes the elements in the range start to end exclusive and replaces them with
 * the contents of the iterable.
 * @description Checks that the elements within the range are replaced with elements
