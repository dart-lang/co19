 ...
 */
/**
 * @assertion Date subtract(Duration other) does not affect TimeZone
...
main() {
  ...
  dt = dt.subtract(new Duration(0, 0, 0, 0, 0));
  Expect.equals(new TimeZone.local(), dt.timeZone);

  dt = new Date.withTimeZone(2001, 1, 1, 0, 0, 0, 0, new TimeZone.local());
  dt = dt.subtract(new Duration(9223372036854775808, 9223372036854775808,
