...
void check(dt, tz){
  ...
  dt.changeTimeZone(new TimeZone(new Time(0, 3, 0, 0, 0)));
  Expect.equals(tz, dt.timeZone);
}
...
main() {
  ...
  check(new Date.withTimeZone(2001, 2, 3, 4, 5, 6, 7, new TimeZone(new Time(0, 3, 0, 0, 0))), new TimeZone(new Time(0, 3, 0, 0, 0)));
}
