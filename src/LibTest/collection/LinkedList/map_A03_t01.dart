 ...
 * The transformed elements will not be cached. Iterating multiple times over the the returned
 * Iterable will invoke the supplied function f multiple times on the same element.
