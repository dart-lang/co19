 ...
 */
/**
 * @assertion When template end tag is met, implied end tags should be
 * generated.
 */
...
main() {
  ...
  test('Test some text and DIV element', () {
    var doc = newHtmlDocument();
