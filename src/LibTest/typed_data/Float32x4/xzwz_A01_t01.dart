 ...
 */
/**
 * @assertion final Float32x4 xzwz
...
check(x, y, z, w) {
  ...
  Expect.approxEquals(obj.z, res.y, (z/1e7).abs());
  Expect.approxEquals(obj.w, res.z, (w/1e7).abs());
  Expect.approxEquals(obj.z, res.w, (z/1e7).abs());
}
