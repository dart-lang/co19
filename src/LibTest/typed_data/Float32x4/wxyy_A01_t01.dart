 ...
 */
/**
 * @assertion final Float32x4 wxyy
...
check(x, y, z, w) {
  ...
  var res = obj.wxyy;
  Expect.approxEquals(obj.w, res.x, (w/1e7).abs());
  Expect.approxEquals(obj.x, res.y, (x/1e7).abs());
  Expect.approxEquals(obj.y, res.z, (y/1e7).abs());
  Expect.approxEquals(obj.y, res.w, (y/1e7).abs());
}
