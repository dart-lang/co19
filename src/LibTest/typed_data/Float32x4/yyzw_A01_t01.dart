 ...
 */
/**
 * @assertion final Float32x4 yyzw
...
check(x, y, z, w) {
  ...
  var res = obj.yyzw;
  Expect.approxEquals(obj.y, res.x, (y/1e7).abs());
  Expect.approxEquals(obj.y, res.y, (y/1e7).abs());
  Expect.approxEquals(obj.z, res.z, (z/1e7).abs());
  Expect.approxEquals(obj.w, res.w, (w/1e7).abs());
}
