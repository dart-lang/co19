 ...
 */
/**
 * @assertion Uint32x4 withFlagZ(bool z)
 ...
 * except [z] equal to corresponding lanes of [this]. Checks that
 * [z] of new [Uint32x4] equals the [z] parameter of the method.
 * @author msyabro
 */
...
check(x, y, z, w, newZ) {
  var obj1 = new Uint32x4.bool(x, y, z, w);
