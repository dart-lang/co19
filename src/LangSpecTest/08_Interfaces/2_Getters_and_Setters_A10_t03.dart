 ...
 * @description Checks that it is a static warning if an interface declares a setter
 * and inherits a getter with the same name but their return/parameter types are not
 * mutually assignable.
 * @author rodionov
 * @reviewer kaigorodov
 * @static-warning
