 ...
 * non-dynamic return type and a bunch of formal and optional parameters.
 * @author iefremov
 * @reviewer rodionov
 */
...
main() {
  ...
  Expect.isTrue(C f(num i, A b, Map<Object, Object> m, var x, [var ox, A2 ob, List ol, bool obool, A xx, B yy]) {} is f1);
