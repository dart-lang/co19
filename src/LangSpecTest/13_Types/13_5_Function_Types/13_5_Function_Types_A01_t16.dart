 ...
 * @description Checks that function type t1 is not a subtype of function type t2 if formal parameter
 * of t1 is not assignable to corresponding parameter of t2 (t1 and t2 both have a single parameter).
 * @author iefremov
 */
