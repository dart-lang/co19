 ...
 * @description Checks that this statement is true for a parameterized interface type extending other parameterized
 * interface type with the same type parameter.
 * @author iefremov
 * @reviewer rodionov
 */
