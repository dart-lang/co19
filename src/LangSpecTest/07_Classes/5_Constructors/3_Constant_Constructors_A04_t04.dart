 ...
 * @description Checks that it is not a compile-time error when a constant constructor's
 * initializer list contains only potentially constant expressions.
 * @author rodionov
 */

class A {
  final x, y;
  const A(int i) : x = [i.toRadixString(10), i, i is int], y = const Duration(2);
}
