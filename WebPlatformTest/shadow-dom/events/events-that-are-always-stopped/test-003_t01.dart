...
main() {
  ...
  s.addEventListener('select', (event) {
    assert_equals(event.target.getAttribute('id'), 'inp1', 'Insidow shadoe tree: Wrong target');
  }, false);
  ...
  var event = new Event("select", canBubble: true, cancelable: false);
