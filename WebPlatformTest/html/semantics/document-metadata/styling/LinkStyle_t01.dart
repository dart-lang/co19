...
void main() {
      ...
      test(() {
        var style = document.createElement("style") as StyleElement;
        var link = document.createElement("link") as LinkElement;
        assert_equals(style.sheet, null,
            "The sheet attribute of the style element not in a document should be null.");
        assert_equals(link.sheet, null,
            "The sheet attribute of the link element not in a document should be null.");
      ...
      test(() {
        ...
        for (int i = 5; i < 8; i++) {
          style = document.getElementById("style$i");
          assert_true(style.sheet is StyleSheet,
              "The sheet attribute of style$i should be a StyleSheet object.");
          assert_equals(style.disabled, style.sheet.disabled,
              "The disabled attribute of style$i should equal to the same attribute of StyleSheet.");
        }
      }, "The LinkStyle interface's sheet attribute must return StyleSheet object;"
          + " the disabled attribute must be same as the StyleSheet's disabled attribute");

      test(() {
        assert_equals(document.getElementById("style2").title, "",
            "The title attribute of style2 is incorrect.");
        assert_equals(document.getElementById("style5").title, "",
            "The title attribute of style5 is incorrect.");
        assert_equals(document.getElementById("style6").title,
            "$support/alternate.css", "The title attribute of style6 is incorrect.");
        assert_equals(document.getElementById("style7").title,
            "$support/alternate.css", "The title attribute of style7 is incorrect.");
      }, "The title must be the same as the value of the element's title content attribute");

      test(() {
        assert_equals((document.getElementById("style5") as StyleElement).media,
            "", "The media attribute of style5 is incorrect.");
        assert_equals((document.getElementById("style7") as StyleElement).media,
            "all", "The media attribute of style7 is incorrect.");
