 ...
 */
/*
 * after web-platform-tests/DOMEvents/tests/approved/Propagation.path.target.removed_t01.html
 *
 * @assertion 
 * @description Once determined, the event propagation path must not be changed,
 * even if an element in the propagation path is removed from the DOM
 */
