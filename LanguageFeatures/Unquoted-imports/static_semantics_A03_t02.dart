...
///
/// @description Checks that `import test_package2;` imports the library
...
import test_package2 as l1;
import test_package2 deferred as l2;

main() async {
  Expect.equals("test_package2", libraryId);
  Expect.equals("test_package2", l1.libraryId);
  await l2.loadLibrary();
  Expect.equals("test_package2", l2.libraryId);
}
