...
main() {
  ...
  const Set s9  = {...?(A() is B ? [12345] : null)};

  const Set s10 = {...?(MyClass(12345) is MyClass ? {12} : null)};    //# 03: compile-time error
  const Set s11 = {...?(MyClass(12345) is MyClass ? {null} : 1)};     //# 04: compile-time error
}
