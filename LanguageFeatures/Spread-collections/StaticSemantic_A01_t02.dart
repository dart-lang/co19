 ...
 * not assignable to the collection type for the set.
...
main() {
  var numbers = <num>[1, 2, 3];
  Expect.setEquals([1, 2, 3].toSet(), <int>{...numbers});

  var objects = <Object>[2, 7, 9];
  Expect.setEquals([2, 7, 9].toSet(), <int>{...numbers});

  var a;
  Expect.throws(() => a = <String>{...objects});

  var strings = <String>[];
  Expect.setEquals([11].toSet(), <int>{11, ...Strings});
}
