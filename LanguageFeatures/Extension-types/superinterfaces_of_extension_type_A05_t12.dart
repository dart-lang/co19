...
enum E {
  a, b;
  E operator +(E other) => a;
}

extension type ExtE(E e) implements E {
  int operator +(Object other) => 42;
}

extension type ExtInt(int value) implements num {
  String operator +(int other) => "$value+$other";
}

main() {
  Expect.equals("1+2", ExtInt(1) + 2);
  Expect.equals(3, 2 + ExtInt(1));
  Expect.equals(42, ExtE(E.b) + E.a);
  Expect.equals(42, ExtE(E.b) + "x");
  Expect.equals(E.a, E.b + ExtE(E.b));
}
