...
void main() {
  ...
  e2.noSuchMethod(Invocation.method(Symbol("test"), []), true); // OK, signature is `noSuchMethod(Invocation, [bool])`.

  e1.noSuchMethod(Invocation.method(Symbol("test"), []), true); // Compile-time error, signature is `noSuchMethod(Invocation)`.
//   ^^^^^^^^
