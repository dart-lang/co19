...
test1_1(AET1 a) => switch (a) { B _ => 'B' };
test1_2(AET2 a) => switch (a) { B _ => 'B' };

test2_1(BET1 b) => switch (b) { B _ => 'B', C _ => 'C' };
test2_2(BET2 b) => switch (b) { C _ => 'C', B _ => 'B' };

main() {
  Expect.equals("B", test1_1(AET1(B())));
  Expect.equals("B", test1_1(AET1(C())));
  Expect.equals("B", test1_2(AET2(B())));
  Expect.equals("B", test1_2(AET2(C())));

  Expect.equals("B", test2_1(BET1(B())));
  Expect.equals("B", test2_1(BET1(C())));
  Expect.equals("B", test2_2(BET2(B())));
  Expect.equals("C", test2_2(BET2(C())));
}
