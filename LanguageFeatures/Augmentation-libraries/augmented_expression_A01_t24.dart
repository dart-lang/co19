...
/// augmented getter and evaluates it to the return value. Test a function
/// literal.
...
main() {
  ...
  Expect.equals("Augmented: Original", ET.staticGetter);
  Expect.equals("Augmented: Original", ET(0).instanceGetter);
}
