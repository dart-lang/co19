...
part 'augmented_expression_A04_t12_lib.dart';

void topLevelFunction([int augmented = 0]) {}

class C {
  C();
  factory C.f([int augmented = 0]) => C();
  static void staticMethod([int augmented = 0]) {}
  void instanceMethod([int augmented = 0]) {}
}
...
extension type ET(int _) {
  factory ET.f([int augmented = 0]) => ET(0);
  static void staticMethod([int augmented = 0]) {}
  void instanceMethod([int augmented = 0]) {}
}
