...
augment library 'augmenting_getters_setters_with_variable_A02_t01.dart';

augment String get topLevelVariable => "Augmented1: $augmented";

augment class C {
  augment static String get staticVariable => "Augmented1: $augmented";
  augment String get instanceVariable => "Augmented1: $augmented";
}
