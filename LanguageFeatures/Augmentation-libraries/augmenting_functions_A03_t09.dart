...
/// once. Test instance methods of an enum.
/// @author sgrekhov22@gmail.com

// SharedOptions=--enable-experiment=macros

import augment 'augmenting_functions_A03_t09_lib.dart';
...
main() {
  ...
  Expect.equals("augment instanceMethod2(A);", E.e1.instanceMethod2("A"));
  ...
  Expect.equals(
      "augment v1=F, {required v2=G}", E.e1.instanceMethod5("F", v2: "G"));
  Expect.equals(
