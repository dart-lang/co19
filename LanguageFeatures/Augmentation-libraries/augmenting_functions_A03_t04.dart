...
import augment 'augmenting_functions_A03_t04_lib.dart';
...
main() {
  ...
  Expect.equals("augment staticMethod2(A);", E.staticMethod2("A"));
  ...
  Expect.equals("augment v1=F, {required v2=G}", E.staticMethod5("F", v2: "G"));
  Expect.equals(
