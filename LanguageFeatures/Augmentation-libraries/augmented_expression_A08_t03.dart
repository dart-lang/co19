...
/// taken to be a reference to a declaration which is in scope. Test a variable
/// named `augmented`.
/// @author sgrekhov22@gmail.com

// SharedOptions=--enable-experiment=macros

import augment 'augmented_expression_A08_t03_lib.dart';
import '../../Utils/expect.dart';

final augmented = "augmented";
