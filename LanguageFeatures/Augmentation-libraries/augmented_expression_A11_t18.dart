...
/// non-redirecting generative constructor to have as a named parameter a record
/// with a positional field with the name `augmented`.
...
enum E {
  a0(), a1.foo();
  const E({(int augmented,) r = (0,)});
  const E.foo({(int augmented,) r = (0,)});
}
...
extension type ET(int id) {
  ET.foo(this.id, {(int augmented,) r = (0,)});
}
...
// [analyzer] unspecified
// [cfe] unspecified
  ET.bar(this.id, {(int augmented,) r = (0,)}) {}
//                      ^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
