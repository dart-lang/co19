...
// [cfe] unspecified
augment late final String finalTopLevelVariable = "Augment: $augmented";
//                                                           ^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
...
// [analyzer] unspecified
// [cfe] unspecified
  augment static late final String finalStaticVariable = "Augment: $augmented";
//                                                                  ^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
...
// [analyzer] unspecified
// [cfe] unspecified
  augment late final String finalInstanceVariable = "Augment: $augmented";
//                                                             ^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
