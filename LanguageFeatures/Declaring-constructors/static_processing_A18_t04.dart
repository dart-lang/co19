...
class C3<T> {
  String v1;
  T? v2;
  this({required this.v1, required T? this.v2});
}

class C4 {
  String v1;
  int v2;
  this({required String this.v1, required this.v2});
}
...
main() {
  ...
  Expect.equals("E1", E2.e0.v1);
  Expect.equals(2, E2.e0.v2);

  Expect.equals("E3", E3.e0.v1);
  Expect.equals(2, E3.e0.v2);

  Expect.equals("E4", E4.e0.v1);
