...
main() {
  testme(new Future<Null>(() => null));
  testme(new Future<Future<Null>>(() => null));
  testme(new Future<Future<Future<Null>>>(() => null));
  testme(new Future<Future<Future<Future<Null>>>>(() => null));
  testme(new Future<Future<Future<Future<Future<Null>>>>>(() => null));
}
