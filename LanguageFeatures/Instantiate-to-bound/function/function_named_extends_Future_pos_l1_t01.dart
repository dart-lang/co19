 ...
 *  a loop for function with optional named parameter.
...
main() {
  ...
  testme(a: a1);
  testme(a: new A<Null>());
  testme(a: new A<Future<Null>>());
  testme(a: new A<Future<Future<Null>>>());
  testme(a: new A<Future<Future<Future<Null>>>>());
  testme(a: new A<Future<Future<Future<Future<Null>>>>>());
