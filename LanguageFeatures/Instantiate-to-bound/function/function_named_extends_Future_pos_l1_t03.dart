...
main() {
  testme(x: new Future<Null>(() => null));
  testme(x: new Future<Future<Null>>(() => null));
  testme(x: new Future<Future<Future<Null>>>(() => null));
  testme(x: new Future<Future<Future<Future<Null>>>>(() => null));
}
