...
main() {
  Future<Null> a1 = testme();
  Future<Future<Null>> a2 = testme();
  Future<Future<Future<Null>>> a3 = testme();
  Future<Future<Future<Future<Null>>>> a4 = testme();

  Future a5 = testme<Future<Null>>();
  Future a6 = testme<Future<Future<Null>>>();
  Future a7 = testme<Future<Future<Future<Null>>>>();
  Future a8 = testme<Future<Future<Future<Future<Null>>>>>();
}
