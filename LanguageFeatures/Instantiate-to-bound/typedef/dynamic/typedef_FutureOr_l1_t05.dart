 ...
 * X extends FutureOr<X>> = X Function(X)] (covariant)
...
typedef G<X extends FutureOr<X>> = void Function<Y extends X>();

typedef G_expected = void Function<X extends FutureOr<dynamic>>();
