...
void test(G source) {
  void Function<X extends dynamic Function()>() target1 = source;

  void Function<X extends Never Function()>() target2 = source;
//                                                      ^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  void Function<X extends Null Function()>() target3 = source;
//                                                     ^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
