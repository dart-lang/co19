...
void test(G source) {
  void Function<X extends void Function(dynamic)>() target1 = source;

  void Function<X extends void Function(Never)>() target2 = source;
//                                                          ^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  void Function<X extends void Function(Null)>() target3 = source;
//                                                         ^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
