 ...
 *   [<U1,m ..., Uk,m>].
 * @description Checks that [List] type parameter can be [dynamic], [Object],
 *  [Null], [void], [Future] and [FutureOr].
...
main() {
  ...
  List<dynamic> b1 = new List();
  List<Object> b2 = new List();
  List<void> b3= new List();
  List<Null> b4 = new List();
  List<Future> b5 = new List();
  List<FutureOr> b6 = new List();
}
