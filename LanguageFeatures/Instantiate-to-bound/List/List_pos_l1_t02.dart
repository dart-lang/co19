 ...
 *   [<U1,m ..., Uk,m>].
 * @description Checks that [List<List<int>>] object cannot be assigned to
 *  [List<List>], etc.
 *  variable.
...
main() {
  List<List> l = new List<List<int>>();
  l = new List<List<List<List>>>();
  l = new List<List<dynamic>>();
  l = new List<List<Null>>();
  l = new List<List<List<Future>>>();
  l = new List<List<List<FutureOr>>>();
}
