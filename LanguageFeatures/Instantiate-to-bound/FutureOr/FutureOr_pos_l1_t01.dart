 ...
 *   [<U1,m ..., Uk,m>].
 * @description Checks that [FutureOr] parameter can be [dynamic], [Object],
 *  [Void] and [Null]
...
main() {
  FutureOr f = new Future<dynamic>(() => 12345);
  ...
  FutureOr<dynamic> f1 = new Future(() => 12345);
  f1 = "testme";

  FutureOr<void> f2 = new Future(() => 12345);
  f2 = 1;

  FutureOr<Null> f3 = new Future(() => null);
  f3 = null;
}
