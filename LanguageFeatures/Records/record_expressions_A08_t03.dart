...
String bar<T extends (num, {String name})>(T r) => r.name;

main() {
  var r = (foo, b: bar);
  Expect.equals(3.14, r.$1<(double, {String name})>((3.14, name: "pi")));
  Expect.equals("pi", r.b<(double, {String name})>((3.14, name: "pi")));
}
