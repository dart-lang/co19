...
augment abstract void Function() topLevelVariable;
//               ^^^^^^^^^^^^^^^
...
augment class C {
  augment static void Function() get staticVariable;
//               ^^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  augment static set staticVariable(void Function() _);
//                                  ^^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  augment abstract void Function() instanceVariable;
//                 ^^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
...
// [analyzer] unspecified
// [cfe] unspecified
  augment abstract final void Function() instanceVariable;
//                       ^^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
...
extension type ET(Null Function() instanceVariable) {
  static var staticVariable = () {};
}
