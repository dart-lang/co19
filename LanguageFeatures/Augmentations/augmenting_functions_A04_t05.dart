...
///
/// @description Checks that it is a compile-time error if the number of named
...
augment void topLevelFunction1({int i = 0});
//           ^^^^^^^^^^^^^^^^^
...
augment class C {
  augment static void staticMethod1({int i = 0});
//                    ^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
...
// [analyzer] unspecified
// [cfe] unspecified
  augment void instanceMethod1({int i = 0});
//             ^^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
