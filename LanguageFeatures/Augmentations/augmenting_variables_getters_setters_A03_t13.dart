...
///
/// @description Checks that a `late final` variable with no initializer may be
/// augmented by a setter.
...
late final int topLevelVariable;
augment void set topLevelVariable(int _);

class C {
  static late final int staticVariable;
  late final int instanceVariable;
}
