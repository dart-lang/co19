...
/// constructor omits types of declaring parameters.
...
class C1(var int x, [final int y = 0]) {}

augment class C1 {
  augment C1(x, [y]);
}

class C2({required final int x, var int y = 0}) {}

augment class C2 {
  augment C2({required x, y});
}

enum E1(final int x, [final int y = 0]) {
  e0(0), e1(1, 2);
}
...
main() {
  ...
  ET.new.expectStaticType<Exactly<ET Function(int x)>>();
