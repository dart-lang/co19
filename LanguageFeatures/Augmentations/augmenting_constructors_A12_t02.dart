...
class C1([var int _ = 0]);
augment class C1([int x]);
//                    ^
// [analyzer] unspecified
// [cfe] unspecified

class C2([var int _ = 0]);
...
class C4([final int _ = 0]);
augment class C4([int x]);
//                    ^
// [analyzer] unspecified
// [cfe] unspecified

class C5([final int _ = 0]);
augment class C5([int _x]);
//                    ^^
// [analyzer] unspecified
// [cfe] unspecified

class C6([final int _ = 0]);
augment class C6([int __]);
//                    ^^
// [analyzer] unspecified
// [cfe] unspecified

enum E1([final int _ = 0]) {
  e0;
}
