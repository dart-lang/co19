...
///
/// @description Checks that it is a compile-time error if the names of named
...
augment void topLevelFunction({int j});
//                                 ^
...
augment class C {
  augment static void staticMethod({int j});
//                                      ^
// [analyzer] unspecified
// [cfe] unspecified

  augment void instanceMethod({int j});
//                                 ^
// [analyzer] unspecified
// [cfe] unspecified
}
