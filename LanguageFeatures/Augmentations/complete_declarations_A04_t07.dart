...
/// getter by complete implicit getter.
/// @author sgrekhov22@gmail.com

// SharedOptions=--enable-experiment=augmentations

external String get topLevelGetter1;
augment final String topLevelGetter1 = "y";
//                   ^^^^^^^^^^^^^^^
...
augment class C {
  augment static final String staticGetter = "y";
//                            ^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  augment external final String instanceGetter;
//                              ^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
...
augment mixin M {
  augment external static final String staticGetter;
//                                     ^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  augment final String instanceGetter = "y";
//                     ^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
