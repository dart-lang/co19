...
///
/// @description Checks that it is not an error if the parameter name of
/// an augmenting setter is `_`.
...
void set topLevelSetter1(int x);
...
augment void set topLevelSetter2(int x);
augment void set topLevelSetter2(int _);

class C {
  static void set staticSetter1(int x);
  ...
  augment static void set staticSetter2(int x);
  augment static void set staticSetter2(int _);

  void set instanceSetter1(int x);
  ...
  augment void set instanceSetter2(int x);
  augment void set instanceSetter2(int _);
}
...
main() {
  ...
  Expect.equals(18, log);

  ET.staticSetter1 = 19;
  ET.staticSetter2 = 20;
  Expect.equals(20, log);
