...
abstract Function() topLevelVariable;

augment dynamic Function() topLevelVariable = foo;

class C {
  abstract Function() instanceVariable;
}

augment class C {
  augment dynamic Function() instanceVariable = foo;
}
...
enum E {
  e0;
  abstract final Function() instanceVariable;
}

augment enum E {
  ;
  augment final dynamic Function() instanceVariable = foo;
}
