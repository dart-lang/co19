...
/// augmenting a non-existent setter.
...
augment String topLevelGetter = ""; // There is no setter to augment
//             ^^^^^^^^^^^^^^
...
class C {
  ...
  augment static String staticGetter = "";
//                      ^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  augment String instanceGetter = "";
//               ^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
