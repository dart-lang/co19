...
/// of a declaring variable of a primary constructor. Test the case when the
/// type is obtained via override inference.
...
main() {
  C(0).foo.expectStaticType<Exactly<int>>();
  Expect.equals(42, C(42).foo);
}
