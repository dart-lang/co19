...
part 'complete_declarations_A07_t01_lib.dart';
...
class C extends A {
  @override
  String abstractMethod() => 'abstractMethod';
  @override
  String get abstractGetter => 'abstractGetter';
  @override
  void set abstractSetter(String v) {
    log = v;
  }
  @override
  String abstractVariable = 'abstractVariable';
  @override
...
main() {
  ...
  C().abstractSetter = 'x';
  Expect.equals('x', log);
  Expect.equals('abstractVariable', C().abstractVariable);
  Expect.equals('y', C() + 'y');
