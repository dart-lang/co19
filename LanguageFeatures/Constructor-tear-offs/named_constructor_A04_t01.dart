...
main() {
  ...
  Expect.runtimeIsType<C Function(int)>(v2);
  v2(14);

  var v3 = C.constr3;
  Expect.isTrue(v3 is C Function(dynamic));
  Expect.runtimeIsType<C Function(dynamic)>(v3);
  v3(0);
  v3(null);

  var v4 = C.constr4;
  Expect.isTrue(v4 is C Function(int, String, List<int>));
  Expect.runtimeIsType<C Function(int, String, List<int>)>(v4);
  v4(1, "123", [1, 2, 3]);

  var v5 = C.constr5;
  Expect.isTrue(v5 is C Function(dynamic, dynamic, dynamic));
  Expect.runtimeIsType<C Function(dynamic, dynamic, dynamic)>(v5);
  v5(1, "123", [1, 2, 3]);
}
