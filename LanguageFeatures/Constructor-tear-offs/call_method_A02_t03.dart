...
main() {
  ...
  String Function(String) f2 = funcValue1.call;
  Expect.equals("Lily was here", f2("Lily was here"));

  C c = new C();
  var funcValue2 = c.instanceMethod;
  var f3 = funcValue2.call<int>;
  Expect.equals(43, f3(43));
  String Function(String) f4 = funcValue2.call;
  Expect.equals("Lily was not here", f4("Lily was not here"));
}
