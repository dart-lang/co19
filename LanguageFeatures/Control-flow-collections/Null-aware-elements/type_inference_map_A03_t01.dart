...
///       not, so it is inferred as normal.
///
/// @description Check that inferred value type of an element `ek: ?ev` in an
/// unknown context is `ek: NonNull(Uv)`, where `Uv` is the inferred type of the
...
main() {
  String? ev = 2 > 1 ? "ev" : null;

  var map = {
    1 : ?ev,
    2: ?null
  };
  map.expectStaticType<Exactly<Map<int, String>>>();
}
