...
///
/// @description Check that if `element` has a null-aware key and `kv` is `null`
/// then evaluation is stopped.
...
main() {
  ...
  Expect.equals("f(1);f(2);f(null);", _log);
  _log = "";
  ...
  Expect.equals("f(1);f(2);f(null);f(5);f(6);", _log);
  _log = "";
  ...
  Expect.equals("f(0);f(1);f(null);f(2);f(3);", _log);
  _log = "";
