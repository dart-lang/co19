...
/// one member but `m` is not invoked. Test a variable as `m`.
...
main() {
  Expect.equals(1, ExtC1.v);
  Expect.equals(2, ExtC2.v);
  Expect.equals(1, ExtM1.v);
  Expect.equals(2, ExtM2.v);
  Expect.equals(1, ExtET1.v);
  Expect.equals(2, ExtET2.v);
  Expect.equals(1, ExtE1.v);
  Expect.equals(2, ExtE2.v);
}
