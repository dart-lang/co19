...
/// @description Checks that simple bounds are correct for [ttypedef G<X extends
/// A> = void Function(X?)] parameter (contravariant, nullable)
/// @author iarkh@unipro.ru

import "../../../Utils/expect.dart";

class A<X> {}
typedef G<X extends A> = void Function(X?);
