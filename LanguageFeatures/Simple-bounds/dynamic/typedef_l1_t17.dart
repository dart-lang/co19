...
/// @description Checks that simple bounds are correct for [typedefG<X extends
/// num> = void Function<Y extends X>] (covariant, nullable)
/// @author iarkh@unipro.ru

import "../../../Utils/expect.dart";

typedef G<X extends num> = void Function<Y extends X?>();
typedef G_expected = void Function<Y extends num?>();
