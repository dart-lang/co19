...
testA() {
  ...
  F<A<List<List<dynamic>?>?>?>? target01 = fsource;
//                                         ^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  F<A<List<List<dynamic>>?>?>? target02 = fsource;
//                                        ^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  F<A<List<List<dynamic>?>>?>? target03 = fsource;
//                                        ^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
...
testB() {
  ...
  F<B<Map<Map<dynamic, dynamic>?, Map<dynamic, dynamic>?>?>?>? target1 = fsource;
//                                                                       ^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  F<B<Map<Map<dynamic, dynamic>, Map<dynamic, dynamic>>?>?>? target2 = fsource;
//                                                                     ^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  F<B<Map<Map<dynamic, dynamic>?, Map<dynamic, dynamic>?>>?>? target3 = fsource;
//                                                                      ^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
