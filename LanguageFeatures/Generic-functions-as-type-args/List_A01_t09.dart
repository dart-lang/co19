...
main() {
  ...
  late List<T Function<T>(T) Function() Function()> l2;
  late List<T Function<T>(T) Function() Function() Function()> l3;
  late List<T Function<T>(T) Function() Function() Function() Function()> l4;
}
