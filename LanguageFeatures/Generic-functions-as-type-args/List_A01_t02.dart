...
main() {
  List<void Function<T>()> l2 = <void Function<T>()>[];
  l2.add(test2);
  Expect.equals(test2, l2[0]);
  l2.add(test3);
  Expect.equals(test3, l2[1]);

  Expect.throws(() { l2.add(1 as dynamic); });
  Expect.throws(() { l2.add(test1 as dynamic); });
  Expect.throws(() { l2.add(test4 as dynamic); });
  Expect.throws(() { l2.add(testme as dynamic); });
}
