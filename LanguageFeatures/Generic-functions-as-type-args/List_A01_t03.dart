...
main() {
  ...
  l3.add(test3);
  Expect.equals(test3, l3[0]);
  Expect.throws(() { l3.add(1 as dynamic); });
  Expect.throws(() { l3.add(test1 as dynamic); });
  Expect.throws(() { l3.add(test2 as dynamic); });
  Expect.throws(() { l3.add(test4 as dynamic); });
}
