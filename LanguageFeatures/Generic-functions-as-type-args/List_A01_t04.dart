...
/// Function()>.
/// @description Checks that generic invariant function can be a class type
...
main() {
  List<void Function<T>(T)> l4 = <void Function<T>(T)>[];
  l4.add(test4);
  Expect.equals(test4, l4[0]);
  Expect.throws(() { l4.add(1 as dynamic); });
  l4.add(test1 as dynamic);
  Expect.throws(() { l4.add(test2 as dynamic); });
  Expect.throws(() { l4.add(test3 as dynamic); });
}
