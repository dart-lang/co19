...
main() {
  List<T Function<T>(T)> l = <T Function<T>(T)>[];
  l.add(test1);
  Expect.equals(test1, l[0]);
  Expect.throws(() { l.add(1 as dynamic); });
  Expect.throws(() { l.add(test2 as dynamic); });
  Expect.throws(() { l.add(test3 as dynamic); });
  Expect.throws(() { l.add(test4 as dynamic); });
}
