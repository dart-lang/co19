...
class C1 extends out_Function implements B {}
//    ^^
// [analyzer] unspecified
// [cfe] unspecified

class C2 extends out_int implements B {}
//    ^^
// [analyzer] unspecified
// [cfe] unspecified

class C3 extends B implements out_Function {}
//    ^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

class C4 extends B implements out_int{}
//    ^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
