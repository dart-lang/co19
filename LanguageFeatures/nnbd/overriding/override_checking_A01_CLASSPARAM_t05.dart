 ...
 * class, legacy type parameter is OK if parent class type parameter is nullable.
 *
...
class A3<T extends int>      extends OPTED_NULLABLE_INT<T>      { dynamic getParamType() => typeOf<T>(); }
class A4<T extends Object>   extends OPTED_NULLABLE_OBJECT<T>   { dynamic getParamType() => typeOf<T>(); }
