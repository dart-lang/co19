 ...
 *
 * @description Check that if opted-in class extends legacy class, compile time
 * error is thrown if parent legacy method parameter is of any legacy type and
 * child opted-in method parameter is [Never].
 *
