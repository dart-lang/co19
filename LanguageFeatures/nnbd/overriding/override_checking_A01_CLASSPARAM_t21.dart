 ...
 * opted-in class, legacy type parameter is OK and the fact that parent class
 * type parameter is non-nullable is ignored.
 *
...
class A3<T extends Function> with OPTED_NONNULLABLE_FUNCTION<T> { dynamic getParamType() => typeOf<T>(); }
