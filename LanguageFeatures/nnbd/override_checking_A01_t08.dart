 ...
 * unmigrated library for getters which return non-null value ([extends]
 * clause).
 *
...
main() {
  A a = A();
  Expect.equals("a", a.get_field1);
  Expect.equals("b", a.get_field2);
  ...
  C c = C();
  Expect.equals("a", c.get_field1);
  Expect.equals("b", c.get_field2);
}
