...
main() {
  Expect.equals(4, AB().test_required(i: null));
  Expect.equals(5, BC().test_required(i: null));
  Expect.equals(6, AC().test_required(i: null));
  Expect.equals(7, AA1().test_required(i: null));
  Expect.equals(8, BA1().test_required(i: null));
  Expect.equals(9, CA1().test_required(i: null));
}
