 ...
 * nullable [FutureOr] and the expression can be non-null.
 *
 * Issue 41437
...
Future<FutureOr<bool?>> test() async {
  FutureOr<bool?> b = await true;
  FutureOr<int?> i = await 1;
  FutureOr<String?> s = await 'hello';
  FutureOr<Object?> o = await new Object();
  return b;
}
