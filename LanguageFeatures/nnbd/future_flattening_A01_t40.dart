 ...
 * non-nullable legacy [FutureOr] dynamically and the expression cannot be
 * [null]. Check that compile error is not thrown if [A] is a legacy class and
 * synchronous function with [FutureOr<A>] return value type returns a value of
 * the type [dynamic].
 *
 * See also:
