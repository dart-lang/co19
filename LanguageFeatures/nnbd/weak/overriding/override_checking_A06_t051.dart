...
///
/// @description Check that result of [NNBD_TOP_MERGE(void, void*)] is [void].
///
...
main() {
  ...
  Expect.runtimeIsType<void Function(void)>(D1().f);
  Expect.runtimeIsType<void Function(void)>(D2().f);
}
