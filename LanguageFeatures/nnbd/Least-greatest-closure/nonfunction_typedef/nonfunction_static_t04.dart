 ...
 * @description Check the [class A<X extends A<X>>; typedef C<X> = A<X>] case:
 * it is not true that [Object?] <: [C<Object?>], and this means that the
 * inferred type does not satisfy the declared bound. A generic function
 * invocation cannot be super-bounded, so the choice must be rejected. So,
 * compiler error should be thrown for [f<X>(C<X> Function() g) => g()].
