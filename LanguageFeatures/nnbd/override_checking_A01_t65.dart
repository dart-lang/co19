 ...
 * parent class are ignored in the child class type parameters.
 *
...
main() {
  DE<A> de = DE<A>();
  Expect.equals(A, de.getParamType());

  DF<A> df = DF<A>();
  Expect.equals(A, df.getParamType());

  EF<A> ef = EF<A>();
  Expect.equals(A, ef.getParamType());
}
