...
class C {
  static void test1(int v, [FutureOr<Never> fo]) {}
//                                          ^^
// [analyzer] unspecified
// [cfe] unspecified

  static void test2(int v, {FutureOr<Never> fo}) {}
//                                          ^^
// [analyzer] unspecified
// [cfe] unspecified

  void test11(int v, [FutureOr<Never> fo]) {}
//                                    ^^
// [analyzer] unspecified
// [cfe] unspecified

  void test22(int v, {FutureOr<Never> fo}) {}
//                                    ^^
// [analyzer] unspecified
// [cfe] unspecified
}

void test1(int v, [FutureOr<Never> fo]) {}
//                                 ^^
// [analyzer] unspecified
// [cfe] unspecified

void test2(int v, {FutureOr<Never> fo}) {}
//                                 ^^
// [analyzer] unspecified
// [cfe] unspecified
