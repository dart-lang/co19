 ...
 * unmigrated library if method argument is not [null] (check case when class
...
main() {
  Expect.equals(4, AB().test_nullable(1));
  Expect.equals(5, BC().test_nullable(1));
  Expect.equals(6, AC().test_nullable(1));
  Expect.equals(7, AA1().test_nullable(1));
  Expect.equals(8, BA1().test_nullable(1));
  Expect.equals(9, CA1().test_nullable(1));
}
