...
main() {
  ...
  E? e2 = .staticGetter;
  Expect.equals(E.e1, e2);

  E? e3 = .staticMethod();
  Expect.equals(E.e2, e3);

  E<dynamic>? e4 = .staticMethod();
  Expect.equals(E.e2, e4);

  E<String>? e5 = .instance;
  Expect.equals(E.e3, e5);

  E? e6 = .instance;
  Expect.equals(E.e3, e6);

  E<String>? e7 = .e4;
  Expect.equals(E.e4, e7);

  E? e8 = .e4;
  Expect.equals(E.e4, e8);
}
