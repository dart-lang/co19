...
/// null-assert pattern it's treated as a normal constant expression, using the
...
main() {
  ...
  M m = MC(1);
  if (m case M.one!) {        // ignore: unnecessary_null_assert_pattern
    res = "M Ok";
  }
  Expect.equals("M Ok", res);

  if (E.e1 case E.one!) {     // ignore: unnecessary_null_assert_pattern
    res = "E Ok";
  }
  Expect.equals("E Ok", res);

  if (E.e1 case E.e1!) {      // ignore: unnecessary_null_assert_pattern
    res = "E Ok again";
  }
  Expect.equals("E Ok again", res);

  if (ET(1) case ET.one!) {   // ignore: unnecessary_null_assert_pattern
    res = "ET Ok";
  }
