...
///      ('=' <expression>)?;
///
/// @description Check that parameter of the primary constructor may have
/// metadata.
...
class C(@meta var int x, @meta int y);

enum E(@meta final int x, @meta int y) {
  e0(0, 0);
}

extension type ET(@meta int x) {}
