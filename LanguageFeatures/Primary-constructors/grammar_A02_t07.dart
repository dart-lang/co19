...
/// `factory` if the first token of a `<memberDeclaration>` is `augment` not
...
class C2 {
  ...
  static factory();
  augment static factory() => C2(2);
}

extension type ET1(int v) {
  ET1 factory();
  augment ET1 factory() => ET1(1);
}

extension type ET2(int v) {
  static factory();
  augment static factory() => ET2(2);
}
