...
/// a `final` optional named parameter.
/// @author sgrekhov22@gmail.com

// SharedOptions=--enable-experiment=primary-constructors

void topLevel1({final v}) {}
//              ^^^^^
// [analyzer] unspecified
// [cfe] unspecified
void topLevel2({final int? v}) {}
//              ^^^^^
// [analyzer] unspecified
// [cfe] unspecified

class C {
  static void staticMethod1({final v}) {}
//                           ^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  static void staticMethod2({final int? v}) {}
//                           ^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  void instanceMethod1({final v}) {}
//                      ^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  void instanceMethod2({final int? v}) {}
//                      ^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
