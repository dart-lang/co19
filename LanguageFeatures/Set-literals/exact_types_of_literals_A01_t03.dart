...
main() {
  ...
  checkType(checkIs<LinkedHashMap<dynamic, dynamic>>, true, {});
  checkType(checkIs<LinkedHashMap<int, int>>, true, <int, int>{});
  checkType(checkIs<LinkedHashSet<int>>, true, <int>{});
  checkType(checkIs<LinkedHashMap<int, int>>, true, {1: 1});
  checkType(checkIs<LinkedHashSet<int>>, true, <int>{});

  Iterable<int> v6 = {};
  Expect.isTrue(v6 is LinkedHashSet<int>);
  checkType(checkIs<LinkedHashSet<int>>, true, v6);
  Map<int, int> v7 = {};
  Expect.isTrue(v7 is LinkedHashMap<int, int>);
  checkType(checkIs<LinkedHashMap<int, int>>, true, v7);
  Object v8 = {};
  Expect.isTrue(v8 is LinkedHashMap<dynamic, dynamic>);
  checkType(checkIs<LinkedHashMap<dynamic, dynamic>>, true, v8);
  Iterable<num> v9 = {1};
  Expect.isTrue(v9 is LinkedHashSet<num>);
  checkType(checkIs<LinkedHashSet<num>>, true, v9);
  Iterable<num> v10 = <int>{};
  Expect.isTrue(v10 is LinkedHashSet<int>);
  checkType(checkIs<LinkedHashSet<int>>, true, v10);
  Set<int> v11 = {};
  Expect.isTrue(v11 is LinkedHashSet<int>);
  checkType(checkIs<LinkedHashSet<int>>, true, v11);

  const v12 = {};
  Expect.isTrue(v12 is Map<dynamic, dynamic>);
  checkType(checkIs<Map<dynamic, dynamic>>, true, v12);
  const v13 = {1};
  Expect.isTrue(v13 is Set<int>);
  checkType(checkIs<Set<int>>, true, v13);
  const Set v14  = {} ;
  Expect.isTrue(v14 is Set<dynamic>);
  checkType(checkIs<Set<dynamic>>, true, v14);
  Set v15 = const {4};
  Expect.isTrue(v15 is Set<dynamic>);
  checkType(checkIs<Set<dynamic>>, true, v15);

  var v16 = {1, 2, 3, 2, 1};
  Expect.isTrue(v16 is LinkedHashSet<int>);
  checkType(checkIs<LinkedHashSet<int>>, true, v16);
  var v18 = const {1, 2};
  Expect.isTrue(v18 is Set<int>);
  checkType(checkIs<Set<int>>, true, v18);

  var v19 = {C(1, "a"), C(2, "a"), C(1, "b")};
  Expect.isTrue(v19 is LinkedHashSet<C>);
  checkType(checkIs<LinkedHashSet<C>>, true, v19);

  var v23 = {1, 2.5};
  Expect.isTrue(v23 is LinkedHashSet<num>);
  checkType(checkIs<LinkedHashSet<num>>, true, v23);
  var v24 = {1, false};
  Expect.isTrue(v24 is LinkedHashSet<Object>);
  checkType(checkIs<LinkedHashSet<Object>>, true, v24);
  const v26  = {1, false};
  Expect.isTrue(v26 is Set<Object>);
  checkType(checkIs<Set<Object>>, true, v26);
}
