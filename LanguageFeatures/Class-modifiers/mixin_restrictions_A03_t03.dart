...
/// - is not external.
///
/// @description Check that it is a compile-time error if an
/// `abstract mixin class` declares a non-trivial generative constructor
