...
base class ClassWithTypedefAbstractBaseMixinClass with TypedefAbstractBaseMixinClass {}

base class ImplementsClassWithTypedefAbstractBaseMixinClass implements ClassWithTypedefAbstractBaseMixinClass {}
//                                                                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
...
main() {
  ...
  print(ImplementsClassWithTypedefAbstractBaseMixinClass);
}
