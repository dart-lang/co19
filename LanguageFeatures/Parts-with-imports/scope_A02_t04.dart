...
///
/// @description Check that it is a compile-time error to access declarations
/// introduced by `import` directive but hidden by `show` or `hide`.
/// @author sgrekhov22@gmail.com

// SharedOptions=--enable-experiment=enhanced-parts

part 'scope_A02_t04_part1.dart';
