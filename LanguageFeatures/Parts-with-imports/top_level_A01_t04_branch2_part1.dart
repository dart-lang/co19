...
part 'top_level_A01_t04_branch2_part2.dart';

String _b2p1Var = "_b2p1Var";
String get _b2p1Getter => "_b2p1Getter";
void set _b2p1Setter(String _) {}
String _b2p1Func() => "_b2p1Func";

class _B2p1Class {
  static final id = "_B2p1Class";
}

mixin _B2p1Mixin {
  static final id = "_B2p1Mixin";
}

enum _B2p1Enum {
  e0;
  static final id = "_B2p1Enum";
}

extension _B2p1Ext on A {
  static final id = "_B2p1Ext";
}

extension type _B2p1ET(int _) {
  static final id = "_B2p1ET";
}
