...
/// and `("[]", [index])` are invoked only once. Test list pattern with a
/// non-matching rest element at the end
...
String test1(Object o) {
  switch (o) {
    case <int>[1]: // Expect call length
      return "match-1";
    case <int>[1, 3, ...]: // Expect call [0], [1]
      return "match-2";
    case <int>[1, 2, ...]: // Expect no additional calls
      return "match-3";
    default:
      return "no match";
  }
...
main() {
  ...
  Expect.equals("length;[0];[1];", ml.log);
  ml.clearLog();
