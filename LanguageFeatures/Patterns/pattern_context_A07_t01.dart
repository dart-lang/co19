...
String testObject4(Shape shape) {
  switch (shape) {
    case Square(areaAsInt: final int _):
      return "match";
    default:
      return "no match";
  }
