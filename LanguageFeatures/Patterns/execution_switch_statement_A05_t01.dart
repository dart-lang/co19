...
///
/// @description Check that if the static type of v is an always-exhaustive
/// type, no case matches, and there is no default clause, then a run-time error
/// is thrown
/// @author sgrekhov22@gmail.com

// SharedOptions=--enable-experiment=patterns

import "patterns_legacy_lib.dart";
...
main() {
  Expect.isTrue(test(boolTrue));
  Expect.isFalse(test(boolFalse));
  Expect.throws(() {test(boolNull);});
}
