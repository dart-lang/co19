...
/// and `("[]", [index])` are invoked only once. Test list pattern with
/// non-matching rest element in the middle of the list
...
String test1(Object o) {
  switch (o) {
    case <int>[1]: // Expect call length
      return "match-1";
    case <int>[1, ..., 4]: // Expect call [0], [2]
      return "match-2";
    case <int>[1, ..., 3]: // Expect no additional calls
      return "match-3";
    default:
      return "no match";
  }
