...
main() {
  Expect.equals("(<int>1, <String>x)", test((a: 1, b: "x")));
  Expect.equals("(<int>42, <String>answer)", test((a: 42, b: "answer")));
  Expect.equals("(<int>1, <int>2)", test((c: 1, d: 2)));
  Expect.equals("(<int>3, <int>4)", test((c: 3, d: 4)));
  Expect.equals("(<String>x, <bool>true)", test((e: "x", f: true)));
  Expect.equals("(<String>y, <bool>false)", test((e: "y", f: false)));
  Expect.equals("(<int>0, final false)", test((g: 0, h: false)));
  Expect.equals("(<int>1, final C)", test((g: 1, h: C())));
  Expect.equals("default", test((a: 1, aa: "x")));
  Expect.equals("default", test((aa: 1, b: "x")));
