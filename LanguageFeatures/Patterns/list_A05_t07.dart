...
///
/// @description Check that parenthesized subpattern can be used in a list's
/// rest pattern
...
String test1(List list) {
  return switch (list) {
    case <int>[1, 2, 3, 4, ... (var r1)] => r1.toString();
    case [2, ...(final r2), 5, 6] => r2.toString();
    case <int>[... /* comment */ (List<int> r3), 6, 7, 8] => r3.toString();
    default => "default";
  };
}
...
main() {
  ...
  var [... /* comment */ (List<int> r3), a3, b3] = [1, 2, 3, 4, 5];
