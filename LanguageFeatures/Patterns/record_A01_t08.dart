...
/// patterns in a switch statement
...
String test(Record record) {
  switch (record) {
    ...
    case (: List<int> case4):
      return "case4 = $case4";
    case (: var case5 as num):
      return "case5 = $case5";
    case (: final case6 as num):
      return "case6 = $case6";
    case (: final Record case7 as ()):
      return "case7 = $case7";
    case (: List<num> case8 as List<int>):
      return "case8 = $case8";
    case (: var case9?):
      return "case9 = $case9";
    case (: final case10?):
