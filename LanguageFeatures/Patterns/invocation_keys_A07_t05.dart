...
/// `("[]", [index])` and `sublist()` are invoked only once. Test list pattern
/// with matching rest element in the middle of the list
...
String test1(Object o) {
  switch (o) {
    ...
    case <int>[1, ... var r, 4]: // Expect call [0], sublist(1, 2), [2]
      return "match-2";
    case <int>[1, ... var r, 3]: // Expect no additional calls
      return "match-3";
    default:
      return "no match";
  }
...
String test2(Object o) =>
  switch (o) {
    <int>[1] => "match-1",
    <int>[1, ... var r, 4] => "match-2",
    <int>[1, ... var r, 3] => "match-3",
    _ => "no match"
  };
...
main() {
  ...
  Expect.equals("length;[0];sublist(1, 2);[2];", ml.log);
  ml.clearLog();
