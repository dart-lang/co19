...
String test1(List list) {
  return switch (list) {
    case <int>[1, 2, 3, 4, ... List r1] => r1.toString();
    case [2, ...List<int> r2, 5, 6] => r2.toString();
    case <int>[... /* comment */ List<num> r3, 6, 7, 8] => r3.toString();
    default => "default";
  };
}
...
String test2(List list) {
  switch (list) {
    case <int>[1, 2, 3, 4, ... List r1]:
      return r1.toString();
    case [2, ...List<int> r2, 5, 6]:
      return r2.toString();
    case <int>[... /* comment */ List<num> r3, 6, 7, 8]:
      return r3.toString();
    default:
      return "default";
  }
...
String test3(List list) {
  if (list case <int>[1, 2, 3, 4, ... List r1]) {
    return r1.toString();
  }
  if (list case [2, ...List<int> r2, 5, 6]) {
    return r2.toString();
  }
  if (list case <int>[... /* comment */ List<num> r3, 6, 7, 8]) {
    return r3.toString();
  }
  return "default";
}
...
main() {
  ...
  final [a2, ...List<int> r2, b2] = [2, 3, 4, 5];
  Expect.equals(2, a2);
  Expect.listEquals([3, 4], r2);
  Expect.equals(5, b2);

  var [... /* comment */ List<num> r3, a3, b3] = [1, 2, 3, 4, 5];
