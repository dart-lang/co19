...
main() async {
  var m1 = {
    await for (var (int v1) in Stream<num>.fromIterable([1, 2, 3])) "k$v1": v1
//                  ^
// [analyzer] unspecified
// [cfe] unspecified
  };
  var m2 = {
    await for (final <int>[v2] in Stream<List<num>>.fromIterable([[1], [2], [3]])) "k$v2": v2
//                   ^
// [analyzer] unspecified
// [cfe] unspecified
  };
  var m3 = {
    await for (var <String, int>{"k1": v3} in Stream<Map<String, num>>.fromIterable([{"k1": 1}])) "k$v3": v3
//                 ^
// [analyzer] unspecified
// [cfe] unspecified
  };
  var m4 = {
    await for (final (int v4,) in Stream<(num,)>.fromIterable([(1,)])) "k$v4": v4
//                    ^
// [analyzer] unspecified
// [cfe] unspecified
  };
  var m5 = {
    await for (var (n: int v5) in Stream<({num n})>.fromIterable([(n: 2)])) "k$v5": v5
//                     ^
// [analyzer] unspecified
// [cfe] unspecified
  };
  var m6 = {
    await for (var Square<Centimeter>(area: v) in Stream<Square<Meter>>.fromIterable([Square<Meter>(1)])) "k$v": v
//                 ^
// [analyzer] unspecified
// [cfe] unspecified
  };
