...
/// getter with the same name of `v` is called. Test the case when the getter is
/// an in-scope extension member
...
extension on Square {
  Unit get extensionArea => this.area;
}

String test1(Object o) {
  switch (o) {
    case Square(extensionArea: u1, size: _):
      return "match";
    default:
      return "no match";
  }
...
String test2(Object o) {
  if (o case Square(size: _, extensionArea: u1)) {
    return "match";
  }
  return "no match";
}
...
String test3(Object o) {
  return switch (o) {
      Square(extensionArea: u1, size: _) => "match",
      _ => "no match"
    };
}

void test4(dynamic o) {
  var Square(extensionArea: v1, size: v2) = o;
}
