...
///
/// @description Check that logical-or subpattern can be used in a list's rest
/// pattern
...
String test1(List list) {
  return switch (list) {
    case <int>[1, 2, 3, 4, ... var r1 || var r1] => r1.toString();
    case [2, ...final r2 || final r2, 5, 6] => r2.toString();
    case <int>[... /* comment */ List<int> r3 || List<int> r3, 6, 7, 8] =>
      r3.toString();
    default => "default";
  };
}
...
String test2(List list) {
  switch (list) {
    case <int>[1, 2, 3, 4, ... var r1 || var r1]:
      return r1.toString();
    case [2, ...final r2 || final r2, 5, 6]:
      return r2.toString();
    case <int>[... /* comment */ List r3 || List r3, 6, 7, 8]:
      return r3.toString();
    default:
      return "default";
  }
...
String test3(List list) {
  ...
  if (list case [2, ...final r2 || final r2, 5, 6]) {
    return r2.toString();
  }
  if (list case <int>[... /* comment */ List r3 || List r3, 6, 7, 8]) {
    return r3.toString();
  }
  return "default";
}
