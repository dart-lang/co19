...
/// inferred for a named getter pattern with the getter name omitted. Test an
/// if-case statement
...
main() {
  Shape shape = Shape();
  if (shape case Circle(:var _ as num)) {}
//                           ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:final _ as num)) {}
//                             ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:int _ as num)) {}
//                           ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:final int _ as num)) {}
//                                 ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(: _ as num)) {}
//                        ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:var _?)) {}
//                           ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:final _?)) {}
//                             ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:int _?)) {}
//                           ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:final int _?)) {}
//                                 ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:_?)) {}
//                       ^
// [analyzer] unspecified
// [cfe] unspecified
  if (shape case Circle(:var _!)) {}
