...
/// new list and that list is matched against the rest subpattern. Test `final`
/// keyword
...
String test1(List list) {
  return switch (list) {
    case <int>[1, 2, 3, 4, ... final r1] => r1.toString();
    case [2, ...final r2, 5, 6] => r2.toString();
    case <int>[... /* comment */ final r3, 6, 7, 8] => r3.toString();
    default => "default";
  };
}
...
String test2(List list) {
  switch (list) {
    case <int>[1, 2, 3, 4, ... final r1]:
      return r1.toString();
    case [2, ...final r2, 5, 6]:
      return r2.toString();
    case <int>[... /* comment */ final r3, 6, 7, 8]:
      return r3.toString();
    default:
      return "default";
  }
...
String test3(List list) {
  if (list case <int>[1, 2, 3, 4, ... final r1]) {
    return r1.toString();
  }
  if (list case [2, ...final r2, 5, 6]) {
    return r2.toString();
  }
  if (list case <int>[... /* comment */ final r3, 6, 7, 8]) {
    return r3.toString();
  }
  return "default";
}
...
main() {
  final <int>[a1, b1, ... r1] = [1, 2, 3, 4, 5];
  Expect.equals(1, a1);
  Expect.equals(2, b1);
  Expect.listEquals([3, 4, 5], r1);

  final [a2, ...r2, b2] = [2, 3, 4, 5];
  Expect.equals(2, a2);
  Expect.listEquals([3, 4], r2);
  Expect.equals(5, b2);

  final [... /* comment */ r3, a3, b3] = [1, 2, 3, 4, 5];
