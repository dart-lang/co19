...
/// with the rest element at the end
...
String test1(Object o) {
  switch (o) {
    case <int>[1]: // Expect call length
      return "match-1";
    case <int>[1, 3, ... var r]: // Expect call [0], [1]
      return "match-2";
    case <int>[1, 2, ... var r]: // Expect call sublist(2, null)
      return "match-3";
    default:
      return "no match";
  }
...
String test2(Object o) =>
  switch (o) {
    <int>[1] => "match-1",
    <int>[1, 3, ... var r] => "match-2",
    <int>[1, 2, ... var r] => "match-3",
    _ => "no match"
  };
