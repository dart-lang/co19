...
class ArgumentsBindingSuper1_t02 {
  ...
  ArgumentsBindingSuper1_t02((int i, String s, {bool b1}) value): m = value {}
  ArgumentsBindingSuper1_t02.named((int i, String s, {bool b1}) value, {(int i, String s, {bool b1}) val2 = t1Default}): m = value {}
  ArgumentsBindingSuper1_t02.positional((int i, String s, {bool b1}) value, [(int i, String s, {bool b1}) val2 = t1Default]): m = value {}
...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s, {bool b1})>.c2(t1Instance, forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s, {bool b1})>.c5(forgetType(t0Instance));
  }, (e) => e is TypeError);

  // test generic class members
  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s, {bool b1})>(t1Instance).superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s, {bool b1})>(t1Instance).superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s, {bool b1})>(t1Instance).superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s, {bool b1})>(t1Instance).superGetter;
  }, (e) => e is TypeError);
