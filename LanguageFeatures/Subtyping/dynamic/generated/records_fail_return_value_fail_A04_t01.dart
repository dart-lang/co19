...
class ReturnValueTest {
  static (int i, String s, {bool b}) staticTestMethod() => forgetType(t0Instance);

  (int i, String s, {bool b}) testMethod() => forgetType(t0Instance);

  (int i, String s, {bool b}) get testGetter => forgetType(t0Instance);
}
...
main() {
  (int i, String s, {bool b}) returnValueLocalFunc() => forgetType(t0Instance);
