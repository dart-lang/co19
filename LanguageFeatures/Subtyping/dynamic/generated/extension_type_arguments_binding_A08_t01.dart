...
main() {
  ...
  namedArgumentsFunc2<ET<Object>>(forgetType(t0Instance), t2: forgetType(t0Instance));

  // test generic class constructors
  ArgumentsBindingGen<ET<Object>> instance2 =
      new ArgumentsBindingGen<ET<Object>>(forgetType(t0Instance));
  instance2 = new ArgumentsBindingGen<ET<Object>>.fNamed(forgetType(t0Instance),
      t2: forgetType(t0Instance));
  instance2 = new ArgumentsBindingGen<ET<Object>>.named(forgetType(t0Instance),
      t2: forgetType(t0Instance));
