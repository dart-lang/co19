...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t02<(int i, String s, {bool b})>.short();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String s, {bool b})>.named();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String s, {bool b})>().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String s, {bool b})>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String s, {bool b})>().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
