...
class ArgumentsBindingClass {
  ArgumentsBindingClass((int i, String s, {bool b1}) t1) {}

  ArgumentsBindingClass.named((int i, String s, {bool b1}) t1, {(int i, String s, {bool b1}) t2 = t1Default}) {}

  factory ArgumentsBindingClass.fNamed((int i, String s, {bool b1}) t1, {(int i, String s, {bool b1}) t2 = t1Default}) {
    return new ArgumentsBindingClass.named(t1, t2: t2);
  }
  factory ArgumentsBindingClass.fPositional((int i, String s, {bool b1}) t1, [(int i, String s, {bool b1}) t2 = t1Default]) {
    return new ArgumentsBindingClass.named(t1, t2: t2);
  }

  static namedArgumentsStaticMethod((int i, String s, {bool b1}) t1, {(int i, String s, {bool b1}) t2 = t1Default}) {}
  static positionalArgumentsStaticMethod((int i, String s, {bool b1}) t1, [(int i, String s, {bool b1}) t2 = t1Default]) {}

  namedArgumentsMethod((int i, String s, {bool b1}) t1, {(int i, String s, {bool b1}) t2 = t1Default}) {}
  positionalArgumentsMethod((int i, String s, {bool b1}) t1, [(int i, String s, {bool b1}) t2 = t1Default]) {}

  set testSetter((int i, String s, {bool b1}) val) {}
}
...
class ArgumentsBindingClassSuper {
  ArgumentsBindingClassSuper((int i, String s, {bool b1}) t1) {}
}

class ArgumentsBindingDesc extends ArgumentsBindingClassSuper {
  ArgumentsBindingDesc((int i, String s, {bool b0}) t0) : super (forgetType(t0)) {}
}
...
main() {
  ...
  // Test constructors
  Expect.throws(() {
    new ArgumentsBindingClassGen<(int i, String s, {bool b1})>(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBindingClassGen<(int i, String s, {bool b1})>.named(t1Instance, t2: forgetType(t0Instance));
  }, (e) => e is TypeError);
