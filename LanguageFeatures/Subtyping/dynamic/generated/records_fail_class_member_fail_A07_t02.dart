...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t02<(int i, String, {List<num> b})>.short();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String, {List<num> b})>.named();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String, {List<num> b})>().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String, {List<num> b})>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int i, String, {List<num> b})>().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
