...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t03<V<int>>(t1Instance).m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<V<int>>(t1Instance).superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<V<int>>(t1Instance).test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<V<int>>(t1Instance).test2();
  }, (e) => e is TypeError);
}
