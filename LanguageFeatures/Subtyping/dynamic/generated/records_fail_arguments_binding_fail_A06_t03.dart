...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<(int i, String, {bool b})>().superTestNamed(forgetType(t0Instance), val2: forgetType(t1Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<(int i, String, {bool b})>().superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<(int i, String, {bool b})>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<(int i, String, {bool b})>().superGetter;
  }, (e) => e is TypeError);
