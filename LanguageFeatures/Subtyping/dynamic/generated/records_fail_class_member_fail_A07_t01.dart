...
class ClassMemberTestStatic {
  ...
  static (int i, String, {List<num> b}) get staticGetter => forgetType(t0Instance);
}
...
class ClassMemberTestPublic {
  ...
  (int i, String, {List<num> b}) get getter => forgetType(t0Instance);
}

class ClassMemberTestPrivate {
  (int i, String, {List<num> b}) _m = t1Default;
...
class ClassMemberTestInitFail {
  static (int i, String, {List<num> b}) s = forgetType(t0Instance);
  (int i, String, {List<num> b}) m = forgetType(t0Instance);
}
...
main() {
  ...
  // Test methods
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String, {List<num> b})>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String, {List<num> b})>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  // Test setters
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String, {List<num> b})>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String, {List<num> b})>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  // Test class variables
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String, {List<num> b})>(t1Instance).m = forgetType(t0Instance);
  }, (e) => e is TypeError);

  // Test constructors
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String, {List<num> b})>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String, {List<num> b})>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String, {List<num> b})>(t0Instance);
  }, (e) => e is TypeError);
