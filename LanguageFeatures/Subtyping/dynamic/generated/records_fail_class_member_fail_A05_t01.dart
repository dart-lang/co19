...
class ClassMemberTestStatic {
  ...
  static (int i, String s, {bool b1}) get staticGetter => forgetType(t0Instance);
}
...
class ClassMemberTestPublic {
  ...
  (int i, String s, {bool b1}) get getter => forgetType(t0Instance);
}
...
class ClassMemberTestInitFail {
  static (int i, String s, {bool b1}) s = forgetType(t0Instance);
  (int i, String s, {bool b1}) m = forgetType(t0Instance);
}
...
main() {
  ...
  // Test methods
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s, {bool b1})>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String s, {bool b1})>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  // Test setters
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s, {bool b1})>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String s, {bool b1})>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  // Test class variables
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s, {bool b1})>(t1Instance).m = forgetType(t0Instance);
  }, (e) => e is TypeError);

  // Test constructors
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s, {bool b1})>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s, {bool b1})>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String s, {bool b1})>(t0Instance);
  }, (e) => e is TypeError);
