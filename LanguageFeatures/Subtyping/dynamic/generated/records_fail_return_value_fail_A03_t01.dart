...
class ReturnValueTest {
  static (int i, String s) staticTestMethod() => forgetType(t0Instance);

  (int i, String s) testMethod() => forgetType(t0Instance);

  (int i, String s) get testGetter => forgetType(t0Instance);
}
...
main() {
  (int i, String s) returnValueLocalFunc() => forgetType(t0Instance);
