...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t03<(int i, String, {List<num> b})>(t1Instance).superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t03<(int i, String, {List<num> b})>(t1Instance).test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
