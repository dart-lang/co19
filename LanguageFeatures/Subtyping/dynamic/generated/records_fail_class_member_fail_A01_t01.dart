...
class ClassMemberTestStatic {
  ...
  static (int, String) get staticGetter => forgetType(t0Instance);
}
...
class ClassMemberTestPublic {
  ...
  (int, String) get getter => forgetType(t0Instance);
}

class ClassMemberTestPrivate {
  (int, String) _m = t1Default;
...
class ClassMemberTestInitFail {
  static (int, String) s = forgetType(t0Instance);
  (int, String) m = forgetType(t0Instance);
}
...
main() {
  ...
  // Test methods
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String)>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int, String)>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  // Test setters
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String)>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int, String)>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  // Test class variables
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String)>(t1Instance).m = forgetType(t0Instance);
  }, (e) => e is TypeError);

  // Test constructors
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String)>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String)>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int, String)>(t0Instance);
  }, (e) => e is TypeError);
