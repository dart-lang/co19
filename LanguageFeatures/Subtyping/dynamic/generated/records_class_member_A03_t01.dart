...
class ClassMember1_t01 {
  ...
  ({String? z, num y, num x}) _p = forgetType(t0Instance);
  ...
  ({String? z, num y, num x}) get getter => forgetType(_p);
  ...
  static ({String? z, num y, num x}) get staticGetter => forgetType(t0Instance);
}
...
main() {
  ...
  forgetType(t0Instance));
  c2 = new ClassMember2_t01<({String? z, num y, num x})>.named(forgetType(t0Instance));
