...
class ArgumentsBindingSuper1_t02 {
  ...
  ArgumentsBindingSuper1_t02((int, String, bool) value): m = value {}
  ArgumentsBindingSuper1_t02.named((int, String, bool) value, {(int, String, bool) val2 = t1Default}): m = value {}
  ArgumentsBindingSuper1_t02.positional((int, String, bool) value, [(int, String, bool) val2 = t1Default]): m = value {}
  ...
  (int, String, bool) get superGetter => forgetType(t0Instance);
...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t02<(int, String, bool)>.c2(t1Instance, forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int, String, bool)>.c5(forgetType(t0Instance));
  }, (e) => e is TypeError);

  // test generic class members
  Expect.throws(() {
    new ArgumentsBinding2_t02<(int, String, bool)>(t1Instance).superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int, String, bool)>(t1Instance).superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int, String, bool)>(t1Instance).superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int, String, bool)>(t1Instance).superGetter;
  }, (e) => e is TypeError);
