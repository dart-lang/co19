...
class ArgumentsBindingDesc extends ArgumentsBindingClassSuper {
  ArgumentsBindingDesc((int, String) t0) : super (forgetType(t0)) {}
}
...
main() {
  ...
  // Test constructors
  Expect.throws(() {
    new ArgumentsBindingClassGen<(int, String, bool)>(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBindingClassGen<(int, String, bool)>.named(t1Instance, t2: forgetType(t0Instance));
  }, (e) => e is TypeError);
