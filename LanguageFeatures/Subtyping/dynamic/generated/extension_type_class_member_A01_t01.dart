...
class ClassMember1_t01 {
  static V<num, Object> s = forgetType(t0Instance);
  V<num, Object> m = forgetType(t0Instance);
  V<num, Object> _p = forgetType(t0Instance);
  ...
  ClassMember1_t01.named(V<num, Object> value) {
    s = value;
    m = value;
    _p = value;
  }
  ...
  set setter(V<num, Object> val) {
    _p = val;
  }

  V<num, Object> get getter => forgetType(_p);

  static staticTest() {
    s = forgetType(t0Instance);
  }

  static set staticSetter(V<num, Object> val) {
    s = val;
  }

  static V<num, Object> get staticGetter => forgetType(t0Instance);
}
...
main() {
  ...
  ClassMember2_t01<V<num, Object>> c2 = new ClassMember2_t01<V<num, Object>>();
  c2 = new ClassMember2_t01<V<num, Object>>.short(forgetType(t0Instance),
  forgetType(t0Instance));
  c2 = new ClassMember2_t01<V<num, Object>>.named(forgetType(t0Instance));
