...
class ClassMemberTestStatic {
  ...
  static (int i, String s) get staticGetter => forgetType(t0Instance);
}
...
class ClassMemberTestPublic {
  ...
  (int i, String s) get getter => forgetType(t0Instance);
}

class ClassMemberTestPrivate {
  (int i, String s) _m = t1Default;
...
class ClassMemberTestInitFail {
  static (int i, String s) s = forgetType(t0Instance);
  (int i, String s) m = forgetType(t0Instance);
}
...
main() {
  ...
  // Test methods
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s)>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String s)>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  // Test setters
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s)>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String s)>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  // Test class variables
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s)>(t1Instance).m = forgetType(t0Instance);
  }, (e) => e is TypeError);

  // Test constructors
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s)>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int i, String s)>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int i, String s)>(t0Instance);
  }, (e) => e is TypeError);
