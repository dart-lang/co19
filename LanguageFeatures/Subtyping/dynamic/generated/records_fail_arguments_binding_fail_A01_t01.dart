...
class ArgumentsBindingClass {
  ArgumentsBindingClass((int, String) t1) {}

  ArgumentsBindingClass.named((int, String) t1, {(int, String) t2 = t1Default}) {}

  factory ArgumentsBindingClass.fNamed((int, String) t1, {(int, String) t2 = t1Default}) {
    return new ArgumentsBindingClass.named(t1, t2: t2);
  }
  factory ArgumentsBindingClass.fPositional((int, String) t1, [(int, String) t2 = t1Default]) {
    return new ArgumentsBindingClass.named(t1, t2: t2);
  }

  static namedArgumentsStaticMethod((int, String) t1, {(int, String) t2 = t1Default}) {}
  static positionalArgumentsStaticMethod((int, String) t1, [(int, String) t2 = t1Default]) {}

  namedArgumentsMethod((int, String) t1, {(int, String) t2 = t1Default}) {}
  positionalArgumentsMethod((int, String) t1, [(int, String) t2 = t1Default]) {}

  set testSetter((int, String) val) {}
}
...
class ArgumentsBindingClassSuper {
  ArgumentsBindingClassSuper((int, String) t1) {}
}

class ArgumentsBindingDesc extends ArgumentsBindingClassSuper {
  ArgumentsBindingDesc((int, String, bool) t0) : super (forgetType(t0)) {}
}
...
main() {
  ...
  // Test constructors
  Expect.throws(() {
    new ArgumentsBindingClassGen<(int, String)>(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBindingClassGen<(int, String)>.named(t1Instance, t2: forgetType(t0Instance));
  }, (e) => e is TypeError);
