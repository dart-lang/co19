...
main() {
  ...
  Expect.throws(() {
    new ClassMember2_t02<(int, String)>.short();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int, String)>.named();
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int, String)>().m = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int, String)>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);
  Expect.throws(() {
    new ClassMember2_t02<(int, String)>().test1();
  }, (e) => e is TypeError);
  Expect.throws(() {
