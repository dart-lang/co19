...
class ArgumentsBindingClass {
  ArgumentsBindingClass((int i, String, {bool b}) t1) {}

  ArgumentsBindingClass.named((int i, String, {bool b}) t1, {(int i, String, {bool b}) t2 = t1Default}) {}

  factory ArgumentsBindingClass.fNamed((int i, String, {bool b}) t1, {(int i, String, {bool b}) t2 = t1Default}) {
    return new ArgumentsBindingClass.named(t1, t2: t2);
  }
  factory ArgumentsBindingClass.fPositional((int i, String, {bool b}) t1, [(int i, String, {bool b}) t2 = t1Default]) {
    return new ArgumentsBindingClass.named(t1, t2: t2);
  }

  static namedArgumentsStaticMethod((int i, String, {bool b}) t1, {(int i, String, {bool b}) t2 = t1Default}) {}
  static positionalArgumentsStaticMethod((int i, String, {bool b}) t1, [(int i, String, {bool b}) t2 = t1Default]) {}

  namedArgumentsMethod((int i, String, {bool b}) t1, {(int i, String, {bool b}) t2 = t1Default}) {}
  positionalArgumentsMethod((int i, String, {bool b}) t1, [(int i, String, {bool b}) t2 = t1Default]) {}

  set testSetter((int i, String, {bool b}) val) {}
}
...
class ArgumentsBindingClassSuper {
  ArgumentsBindingClassSuper((int i, String, {bool b}) t1) {}
}

class ArgumentsBindingDesc extends ArgumentsBindingClassSuper {
  ArgumentsBindingDesc((int i, int, {bool b}) t0) : super (forgetType(t0)) {}
}
...
main() {
  ...
  // Test constructors
  Expect.throws(() {
    new ArgumentsBindingClassGen<(int i, String, {bool b})>(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBindingClassGen<(int i, String, {bool b})>.named(t1Instance, t2: forgetType(t0Instance));
  }, (e) => e is TypeError);
