...
class ClassMemberTestStatic {
  ...
  static (int, String, bool) get staticGetter => forgetType(t0Instance);
}
...
class ClassMemberTestPublic {
  ...
  (int, String, bool) get getter => forgetType(t0Instance);
}
...
class ClassMemberTestInitFail {
  static (int, String, bool) s = forgetType(t0Instance);
  (int, String, bool) m = forgetType(t0Instance);
}
...
main() {
  ...
  // Test methods
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String, bool)>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int, String, bool)>(t1Instance).test(t0Instance);
  }, (e) => e is TypeError);

  // Test setters
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String, bool)>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int, String, bool)>(t1Instance).setter = t0Instance;
  }, (e) => e is TypeError);

  // Test class variables
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String, bool)>(t1Instance).m = forgetType(t0Instance);
  }, (e) => e is TypeError);

  // Test constructors
  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String, bool)>(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPublic<(int, String, bool)>.short(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ClassMemberTestGenericPrivate<(int, String, bool)>(t0Instance);
  }, (e) => e is TypeError);
