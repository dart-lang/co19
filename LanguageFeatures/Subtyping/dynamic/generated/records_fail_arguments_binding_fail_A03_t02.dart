...
class ArgumentsBindingSuper1_t02 {
  ...
  ArgumentsBindingSuper1_t02((int i, String s) value): m = value {}
  ArgumentsBindingSuper1_t02.named((int i, String s) value, {(int i, String s) val2 = t1Default}): m = value {}
  ArgumentsBindingSuper1_t02.positional((int i, String s) value, [(int i, String s) val2 = t1Default]): m = value {}
  ...
  (int i, String s) get superGetter => forgetType(t0Instance);
...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s)>.c2(t1Instance, forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s)>.c5(forgetType(t0Instance));
  }, (e) => e is TypeError);

  // test generic class members
  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s)>(t1Instance).superTest(forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s)>(t1Instance).superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s)>(t1Instance).superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t02<(int i, String s)>(t1Instance).superGetter;
  }, (e) => e is TypeError);
