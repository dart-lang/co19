...
main() {
  ...
  Expect.throws(() {
    new ArgumentsBinding2_t03<(int, String, bool)>().superTestNamed(forgetType(t0Instance), val2: forgetType(t1Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<(int, String, bool)>().superTestNamed(forgetType(t1Instance), val2: forgetType(t0Instance));
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<(int, String, bool)>().superSetter = forgetType(t0Instance);
  }, (e) => e is TypeError);

  Expect.throws(() {
    new ArgumentsBinding2_t03<(int, String, bool)>().superGetter;
  }, (e) => e is TypeError);
