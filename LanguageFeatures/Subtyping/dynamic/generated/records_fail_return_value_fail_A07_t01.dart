...
class ReturnValueTest {
  static (int i, String, {List<num> b}) staticTestMethod() => forgetType(t0Instance);

  (int i, String, {List<num> b}) testMethod() => forgetType(t0Instance);

  (int i, String, {List<num> b}) get testGetter => forgetType(t0Instance);
}
...
main() {
  (int i, String, {List<num> b}) returnValueLocalFunc() => forgetType(t0Instance);
