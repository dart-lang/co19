...
main() {
  ...
  namedArgumentsFunc2<Y>(forgetType(t0Instance), t2: forgetType(t0Instance));

  // test generic class constructors
  ArgumentsBindingGen<Y> instance2 =
      new ArgumentsBindingGen<Y>(forgetType(t0Instance));
  instance2 = new ArgumentsBindingGen<Y>.fNamed(forgetType(t0Instance),
      t2: forgetType(t0Instance));
  instance2 = new ArgumentsBindingGen<Y>.named(forgetType(t0Instance),
      t2: forgetType(t0Instance));
