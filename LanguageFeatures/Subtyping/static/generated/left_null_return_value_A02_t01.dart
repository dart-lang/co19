...
class ReturnValueTest {
  static FutureOr<Null> staticTestMethod() => t0Instance;

  FutureOr<Null> testMethod() => t0Instance;

  FutureOr<Null> get testGetter => t0Instance;
}

main() {
  FutureOr<Null> returnValueLocalFunc() => t0Instance;
