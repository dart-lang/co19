...
class ClassMemberTestStatic {
  ...
  ClassMemberTestStatic((int, String, bool) val) {
    s = val;
//      ^^^
...
// [cfe] unspecified
  ...
  static set staticSetter((int, String, bool) val) {
    s = val;
//      ^^^
// [analyzer] unspecified
// [cfe] unspecified
  ...
  static (int, String) get staticGetter => t0Instance;
//                               ^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
...
class ClassMemberTestPublic {
  ...
  ClassMemberTestPublic((int, String, bool) val) {
    m = val;
//      ^^^
// [analyzer] unspecified
// [cfe] unspecified
...
// [cfe] unspecified
  ...
  set setter((int, String, bool) val) {
    m = val;
//      ^^^
// [analyzer] unspecified
// [cfe] unspecified
  ...
  (int, String) get getter => t0Instance;
//                  ^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
...
class ClassMemberTestPrivate {
  ...
  ClassMemberTestPrivate((int, String, bool) val) {
    _m = val;
//       ^^^
// [analyzer] unspecified
// [cfe] unspecified
...
class ClassMemberTestInitFail {
  static (int, String) s = t0Instance;
//               ^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  (int, String) m = t0Instance;
//        ^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
