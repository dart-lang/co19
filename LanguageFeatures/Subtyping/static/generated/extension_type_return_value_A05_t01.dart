...
V1 returnValueFunc() => t0Instance;

class ReturnValueTest {
  static V1 staticTestMethod() => t0Instance;

  V1 testMethod() => t0Instance;

  V1 get testGetter => t0Instance;
}

main() {
  V1 returnValueLocalFunc() => t0Instance;
