...
class ArgumentsBindingSuper1_t02 {
  ...
  ArgumentsBindingSuper1_t02(V0<String> value): m = value {}
  ArgumentsBindingSuper1_t02.named(V0<String> value, {V0<String> val2 = t1Default}): m = value {}
  ArgumentsBindingSuper1_t02.positional(V0<String> value, [V0<String> val2 = t1Default]): m = value {}
  ArgumentsBindingSuper1_t02.short(this.m);

  void superTest(V0<String> val) {}
  void superTestPositioned(V0<String> val, [V0<String> val2 = t1Default]) {}
  void superTestNamed(V0<String> val, {V0<String> val2 = t1Default}) {}
  V0<String> get superGetter => t0Instance;
//                       ^^^^^^^^^^
// [analyzer] unspecified
// [cfe] unspecified
  void set superSetter(V0<String> val) {}
}

class ArgumentsBinding1_t02 extends ArgumentsBindingSuper1_t02 {
  ArgumentsBinding1_t02(String t0) : super(t0) {}
//                                      ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c1(String t0) : super.named(t0) {}
//                                               ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c2(V0<String> t1, String t2) : super.named(t1, val2: t2) {}
//                                                       ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c3(String t0) : super.positional(t0) {}
//                                                    ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c4(V0<String> t1, String t2) : super.positional(t1, t2) {}
//                                                                ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c5(String t1) : super.short(t1) {}
//                                               ^^
// [analyzer] unspecified
// [cfe] unspecified
