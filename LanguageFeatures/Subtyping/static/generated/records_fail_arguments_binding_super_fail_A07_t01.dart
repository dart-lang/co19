...
class ArgumentsBindingSuper1_t02 {
  ...
  (int i, String, {List<num> b}) get superGetter => t0Instance;
//                       ^^^^^^^^^^
...
class ArgumentsBinding1_t02 extends ArgumentsBindingSuper1_t02 {
  ArgumentsBinding1_t02((int i, String, {bool b}) t0) : super(t0) {}
//                                      ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c1((int i, String, {bool b}) t0) : super.named(t0) {}
//                                               ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c2((int i, String, {List<num> b}) t1, (int i, String, {bool b}) t2) : super.named(t1, val2: t2) {}
//                                                       ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c3((int i, String, {bool b}) t0) : super.positional(t0) {}
//                                                    ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c4((int i, String, {List<num> b}) t1, (int i, String, {bool b}) t2) : super.positional(t1, t2) {}
//                                                                ^^
// [analyzer] unspecified
// [cfe] unspecified
  ArgumentsBinding1_t02.c5((int i, String, {bool b}) t1) : super.short(t1) {}
//                                               ^^
// [analyzer] unspecified
// [cfe] unspecified
