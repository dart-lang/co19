...
V1<num, Object> returnValueFunc() => t0Instance;

class ReturnValueTest {
  static V1<num, Object> staticTestMethod() => t0Instance;

  V1<num, Object> testMethod() => t0Instance;

  V1<num, Object> get testGetter => t0Instance;
}

main() {
  V1<num, Object> returnValueLocalFunc() => t0Instance;
