...
main() {
  ...
  ArgumentsBindingGen<({String? z, num y, num x})> instance2 = new ArgumentsBindingGen<({String? z, num y, num x})>(t0Instance);
  instance2 = new ArgumentsBindingGen<({String? z, num y, num x})>.fNamed(t0Instance, t2: t0Instance);
  instance2 = new ArgumentsBindingGen<({String? z, num y, num x})>.named(t0Instance, t2: t0Instance);
