...
main() {
  ...
  namedArgumentsFunc2<String>(t0Instance, t2: t0Instance);

  // test generic class constructors
  ArgumentsBindingGen<String> instance2 = new ArgumentsBindingGen<String>(t0Instance);
  instance2 = new ArgumentsBindingGen<String>.fNamed(t0Instance, t2: t0Instance);
  instance2 = new ArgumentsBindingGen<String>.named(t0Instance, t2: t0Instance);
