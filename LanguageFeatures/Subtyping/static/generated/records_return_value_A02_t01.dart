...
class ReturnValueTest {
  static (num, num, String?, {num n1, String? n2}) staticTestMethod() => t0Instance;

  (num, num, String?, {num n1, String? n2}) testMethod() => t0Instance;

  (num, num, String?, {num n1, String? n2}) get testGetter => t0Instance;
}

main() {
  (num, num, String?, {num n1, String? n2}) returnValueLocalFunc() => t0Instance;
