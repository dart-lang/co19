...
test(JSObject obj) {
  obj.setProperty(42.toJS, 1.toJS);
  Expect.equals(1, obj.getProperty<JSNumber>(42.toJS).toDartInt);
  obj.setProperty(true.toJS, 2.toJS);
  Expect.equals(2, obj.getProperty<JSNumber>(true.toJS).toDartInt);
