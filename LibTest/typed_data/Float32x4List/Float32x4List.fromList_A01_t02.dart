 ...
 * @description Checks that a new [Float32x4List] has the same size and elements
 * as the [elements].
 * @author msyabro
 */
...
main() {
  ...
  check([pack(2e-10, 4e12, .012e10, 1e15), pack(-2e-10, -1.2e1, -0.23, -4.98e-1),
      pack(2e10, 3e-1, 1.12, 0.5e-1)]);
  check([packV(0.0), packV(1.0), packV(2.0), packV(3.0), packV(4.0), packV(5.0),
      packV(6.0), packV(7.0), packV(8.0),
  packV(9.0), packV(10.0), packV(11.0), packV(12.0), packV(13.0), packV(14.0),
      packV(15.0), packV(16.0), packV(17.0)]);
}
