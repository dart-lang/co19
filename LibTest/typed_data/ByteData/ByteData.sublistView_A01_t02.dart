...
///
/// @description Checks that if `data` is a [ByteData], it's treated like a list
/// of bytes.
...
void test(List<int> array, int start, int? end, int? expected) {
  ...
  final data = ByteData.view(typedData.buffer, 0);
  final bd = ByteData.sublistView(data, start, end);
  if (expected != null) {
