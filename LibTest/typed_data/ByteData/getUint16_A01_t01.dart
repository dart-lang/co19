...
main() {
  var u16 = new Uint16List.fromList([0, 1, 65535, 32768, 12, 54, 100, 23, 98,
      23, 43, 15, 3]);
  ...
  var expectedLittleEndian = [41339, 25319, 28928, 63468, 257, 59160, 52411,
      8067];
  for(int i = 0; i < byteDataFromU32.lengthInBytes / bytesInElement; ++i) {
    ...
    Expect.equals(expectedLittleEndian[i],
        byteDataFromU32.getUint16(i * bytesInElement,
            Endianness.LITTLE_ENDIAN));
  }
}
