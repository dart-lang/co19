...
/// @description Checks that a StateError is thrown if more then one element
/// satisfy test.
...
main() {
  ...
  Expect.throws(() { l.singleWhere((e) => e.x > 2); }, (e) => e is StateError);
  Expect.throws(() { l.singleWhere((e) => e.x != 8); }, (e) => e is StateError);
}
