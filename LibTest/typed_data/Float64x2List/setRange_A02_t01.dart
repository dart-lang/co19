...
main() {
  ...
  Expect.throws(() {
    l.setRange(-1, 5, [f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(4.0),
        f64x2(5.0), f64x2(6.0), f64x2(7.0), f64x2(8.0), f64x2(9.0)]);
  });

  Expect.throws(() {
    l.setRange(3, 2, [f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(4.0),
    f64x2(5.0), f64x2(6.0), f64x2(7.0), f64x2(8.0), f64x2(9.0)]);
  });

  Expect.throws(() {
    l.setRange(10, 2, [f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(4.0),
    f64x2(5.0), f64x2(6.0), f64x2(7.0), f64x2(8.0), f64x2(9.0)]);
  });

  Expect.throws(() {
    l.setRange(3, -1, [f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(4.0),
    f64x2(5.0), f64x2(6.0), f64x2(7.0), f64x2(8.0), f64x2(9.0)]);
  });

  Expect.throws(() {
    l.setRange(3, 10, [f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(4.0),
    f64x2(5.0), f64x2(6.0), f64x2(7.0), f64x2(8.0), f64x2(9.0)]);
  });
}
