...
main() {
  ...
  Expect.throws(() {
    l.setRange(0, 5, [f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(4.0),
    f64x2(5.0), f64x2(6.0), f64x2(7.0), f64x2(8.0), f64x2(9.0)], 7);
  });

  l.setRange(0, 0, [f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(4.0),
     f64x2(5.0), f64x2(6.0), f64x2(7.0), f64x2(8.0), f64x2(9.0)], 9);
  listEquals([f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0),
