...
main() {
  ...
  listEquals([f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(1.0),
      f64x2(2.0), f64x2(2.0), f64x2(2.0), f64x2(2.0)], l);

  l.setAll(0, [f64x2(3.0), f64x2(3.0), f64x2(3.0)]);
  listEquals([f64x2(3.0), f64x2(3.0), f64x2(3.0), f64x2(0.0), f64x2(1.0),
      f64x2(2.0), f64x2(2.0), f64x2(2.0), f64x2(2.0)], l);

  l.setAll(0, [f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0),
      f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0)]);
  listEquals([f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0),
