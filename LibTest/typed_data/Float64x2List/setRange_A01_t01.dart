...
main() {
  ...
  listEquals([f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(1.0),
      f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0)], l);

  l.setRange(5, 7, [f64x2(2.0), f64x2(2.0), f64x2(2.0), f64x2(2.0)]);
  listEquals([f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(1.0),
      f64x2(2.0), f64x2(2.0), f64x2(0.0), f64x2(0.0)], l);

  l.setRange(0, 3, [f64x2(3.0), f64x2(3.0), f64x2(3.0)]);
  listEquals([f64x2(3.0), f64x2(3.0), f64x2(3.0), f64x2(0.0), f64x2(1.0),
      f64x2(2.0), f64x2(2.0), f64x2(0.0), f64x2(0.0)], l);

  l.setRange(4, 9, [f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0),
      f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0)]);
  listEquals([f64x2(3.0), f64x2(3.0), f64x2(3.0), f64x2(0.0), f64x2(4.0),
      f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0)], l);

  l.setRange(0, 2, [f64x2(5.0), f64x2(6.0), f64x2(7.0)], 1);
  listEquals([f64x2(6.0), f64x2(7.0), f64x2(3.0), f64x2(0.0), f64x2(4.0),
      f64x2(4.0), f64x2(4.0), f64x2(4.0), f64x2(4.0)], l);

  l.setRange(7, 8, [f64x2(5.0), f64x2(6.0), f64x2(7.0)], 2);
  listEquals([f64x2(6.0), f64x2(7.0), f64x2(3.0), f64x2(0.0), f64x2(4.0),
      f64x2(4.0), f64x2(4.0), f64x2(7.0), f64x2(4.0)], l);
}
