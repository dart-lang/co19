...
main() {
  ...
  var res = l.lastWhere((element) => element.x > 10);
  Expect.equals(17.0, res.x);
  Expect.equals(17.0, res.y);

  res = l.lastWhere((element) => element.x == 12);
  Expect.equals(12.0, res.x);
  Expect.equals(12.0, res.y);

  res = l.lastWhere((element) => element.x < 7);
  Expect.equals(6.0, res.x);
  Expect.equals(6.0, res.y);
}
