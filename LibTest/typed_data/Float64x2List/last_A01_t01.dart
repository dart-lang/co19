 ...
 * @description Checks that the last element of list is returned.
...
void check(List<Float64x2> list) {
  ...
  Expect.equals(l[l.length - 1].x, l.last.x);
  Expect.equals(l[l.length - 1].y, l.last.y);
}
...
main() {
  ...
  check([f64x2(1.0), f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0), f64x2(0.0),
