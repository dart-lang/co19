...
main() {
  check([], 3);
  check([f64x2(6.0), f64x2(1.0), f64x2(4.0), f64x2(2.0), f64x2(5.0),
      f64x2(3.0)], 7);
  check([f64x2(6.0), f64x2(5.0), f64x2(4.0), f64x2(3.0), f64x2(2.0),
      f64x2(1.0), f64x2(2.0), f64x2(3.0), f64x2(2.0), f64x2(5.0)], 20);
}
