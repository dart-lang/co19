...
void check(ByteBuffer buffer) {
  ...
  // Uint32List view of a byte buffer
  ...
  // Uint32List view of a byte buffer with offset1 and length1
  Uint32List res1 = buffer.asUint32List(offset1, length1);
  int view1Length = res1.length;

  // Uint32List view of a byte buffer with offset2
  Uint32List res2 = buffer.asUint32List(offset2);
