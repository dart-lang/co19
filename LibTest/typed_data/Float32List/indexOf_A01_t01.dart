...
main() {
  ...
  Expect.equals(0, l.indexOf(-1.0, 0));
  Expect.equals(3, l.indexOf(-1.0, 1));
  Expect.equals(3, l.indexOf(-1.0, 3));
  Expect.equals(1, l.indexOf(0.0, 0));
  Expect.equals(2, l.indexOf(0.0, 2));
  Expect.equals(4, l.indexOf(2.0, 1));
}
