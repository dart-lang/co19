...
var messagesList = const [
  ...
  -0.0, 0.0, 3.14, double.NAN, double.INFINITY, double.MAX_FINITE,
  double.MIN_POSITIVE, double.NEGATIVE_INFINITY,
  "", "abrakadabra", "\u1234\u4321",
//a long string
  '''
   * Copyright (c) 2011, the Dart project authors.  Please see the AUTHORS file
...
//a long string
   ...
   * BSD-style license that can be found in the LICENSE file.
  ''',
  "22":double.NAN, "23":double.MAX_FINITE, "24":double.MIN_POSITIVE,
