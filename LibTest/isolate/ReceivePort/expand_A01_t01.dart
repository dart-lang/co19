...
///
/// @description Checks that returned stream produces all the values generated
...
check(List list, Iterable convert(value), List expected) {
...
void checkList(List list) {
  ...
  check(list, (value) => [value, value], expected);
  ...
  check(list, (value) => [value, null], expected);
}
