...
///
/// @description Checks that this constructor creates a JavaScript `Uint32Array`
...
test(int bufferSize, int offset, int length, int value) {
  ...
  JSUint32Array ar = JSUint32Array(buffer, offset, length);
  globalContext["ar"] = ar;
...
main() {
  ...
  test(4, 0, 1, 42);
  test(16, 8, 2, 42);
  test(32, 0, 2, 4294967295);
  test(8, 4, 1, 4294967295);
  test(4, 0, 1, 4294967295);
}
