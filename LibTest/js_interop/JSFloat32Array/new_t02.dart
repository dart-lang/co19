...
/// `Float32Array` with `buffer` as its backing storage, offset by `byteOffset`
...
test(int bufferSize, int offset, int expectedLength, num value) {
  JSArrayBuffer buffer = JSArrayBuffer(bufferSize);
  JSFloat32Array ar = JSFloat32Array(buffer, offset);
  globalContext["ar"] = ar;
