...
/// @assertion JSUint8Array.withLength( int length )
...
/// `Uint8Array` of size `length` whose elements are initialized to `0`.
...
test(int length) {
  JSUint8Array ar = JSUint8Array.withLength(length);
  globalContext["ar"] = ar;
  eval(r'''
