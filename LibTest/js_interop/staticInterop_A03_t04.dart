...
///
/// @description Checks that an extension type annotated with `@staticInterop`
/// can interop with JS objects.
...
@staticInterop
@JS()
extension type ET(JSObject o) implements Object {
}
...
main() {
  ...
  ''');
  ET et = globalContext["obj"] as ET;
  Expect.equals("I'm JS String", et.getString());
  Expect.equals(42, et.getNumber());
  Expect.equals(true, et.getBool());
}
