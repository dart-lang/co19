...
void main() {
  eval(r'''
    ...
    // All operations below produce NaN
    var divNum = underTest / 2; 
    var divStringNum = underTest / "2";
    var divStringText = underTest / "text";
    var divNull = underTest / null;
    var divZero = underTest / 0;
    var divNaN = underTest / (0 / 0);
    var divArrayEmpty = underTest / [];
    var divArrayNum = underTest / [1, 2];
    var divTrue = underTest / true;
    var divFalse = underTest / false;
    var divObject = underTest / {};
    var divFunction = underTest / foo;
  ''');
