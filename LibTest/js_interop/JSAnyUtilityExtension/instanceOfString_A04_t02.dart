...
/// exist, returns `false`.
///
/// @description Checks that `instanceOfString()` returns `false` if this
/// `JSAny?` is is not an `instanceof` the constructor that is defined by
...
main() {
  ...
  completer.future.then((_) {
    ...
    Expect.isFalse(globalContext["objA"].instanceOfString("lib1"));
    Expect.isFalse(globalContext["objB"].instanceOfString("lib1"));
    asyncEnd();
  });
}
