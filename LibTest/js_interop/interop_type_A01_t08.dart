...
/// as representation types. Test extension types that don't implement their
...
extension type BoolET(bool v) {}
extension type NumET(num v)  {}
extension type IntET(int v) {}
extension type DoubleET(double v) {}
extension type StringET(String v) {}
