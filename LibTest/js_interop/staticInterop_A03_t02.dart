...
///
/// @description Checks that a mixin annotated with `@staticInterop` can interop
/// with JS objects.
...
main() {
  ...
  ''');
  M m = globalContext["obj"] as M;
  Expect.equals("I'm JS String", m.getString());
  Expect.equals(42, m.getNumber());
  Expect.equals(true, m.getBool());
}
