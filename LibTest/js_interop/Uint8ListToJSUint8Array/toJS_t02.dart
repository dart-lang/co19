...
/// [JSUint8Array]. Test an array instantiated in JS.
...
main() {
  eval(r'''
    globalThis.a = new Uint8Array(3);
    globalThis.a[0] = 1;
    globalThis.a[1] = 2;
    globalThis.a[3] = 33;
  ''');
  Uint8List l = (globalContext["a"] as JSUint8Array).toDart;
  JSUint8Array a = l.toJS;
  ...
  if (isWasm) {
    // The `Uint8List` was instantiated in JS. This is a wrapping case.
