...
main() {
  ...
  testTrue(document.querySelectorAll('span pre'), 'Descendant selector, direct');
  
  testTrue(document.querySelectorAll('div pre'), 'Descendant selector, indirect');
  ...
  testFalse(document.querySelectorAll('pre:first-child'), 'The :first-child pseudo-class');
  
  testTrue(document.querySelectorAll('pre:lang(en)'), 'The :lang() pseudo-class');

  testFalse(document.querySelectorAll('pre:lang(fr)'), 'The :lang() pseudo-class');

  testTrue(document.querySelectorAll('hr + pre'), 'Adjacent selector');
  
  testFalse(document.querySelectorAll('div + pre'), 'Adjacent selector, negative');

  testTrue(document.querySelectorAll('pre[id]'), 'Attribute selector 1');
  
  testFalse(document.querySelectorAll('pre[foo]'), 'Attribute selector 1, negative');
  
  testTrue(document.querySelectorAll('pre[id="myid"]'), 'Attribute selector 2');
  
  testFalse(document.querySelectorAll('pre[id="myid2"]'), 'Attribute selector 2, negative');
  
  testTrue(document.querySelectorAll('pre[class~="bar"]'), 'Attribute selector 3');

  testFalse(document.querySelectorAll('pre[class~="baz"]'), 'Attribute selector 3, negative');

  testTrue(document.querySelectorAll('pre[lang|="en"]'), 'Attribute selector 4');
  
  testFalse(document.querySelectorAll('pre[lang|="fr"]'), 'Attribute selector 4, negative');
