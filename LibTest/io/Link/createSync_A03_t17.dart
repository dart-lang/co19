...
///
/// @description Checks that if there is an existing [Directory] on the path,
/// then calling `createSync` will throw an exception. Test the case when the
/// new link has a not existing entity as a target
