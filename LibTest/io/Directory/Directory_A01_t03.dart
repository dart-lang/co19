 ...
 * relative path and not existing directory
...
main() {
  Directory dir = new Directory("NotExistent");
  Expect.equals(Directory.current.path + Platform.pathSeparator + "NotExistent",
      dir.absolute.path);
}
