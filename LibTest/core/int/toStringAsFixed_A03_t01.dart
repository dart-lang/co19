...
main() {
  int x = pow(10, 21);
  Expect.equals("1e+21", x.toStringAsFixed(0));
  Expect.equals("1e+21", x.toStringAsFixed(10));
  Expect.equals("1e+21", x.toStringAsFixed(20));

  int y = pow(10, 20);
  Expect.equals("100000000000000000000", y.toStringAsFixed(0));
  Expect.equals("100000000000000000000.0000000000", y.toStringAsFixed(10));
  Expect.equals("100000000000000000000.00000000000000000000", y.toStringAsFixed(20));
}
