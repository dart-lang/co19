 ...
 * @description Check that exception is thrown if both path and pathSegments
 * specified
...
main() {
  ...
  Expect.throws(() {
    url.replace(path: "replaced1", pathSegments: ["replaced2"]);
  });
  Expect.throws(() {
    url.replace(path: "replaced1", pathSegments: []);
  });
  Expect.throws(() {
    url.replace(path: "", pathSegments: ["replaced2"]);
  });
}
