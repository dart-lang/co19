 ...
 * with some parts replaced. Test host
...
main() {
  ...
  var url2 = Uri.parse("http://user:pass@replaced/path/?q#fr");
  Expect.equals(url2, url1.replace(host: "replaced"));

  url1 = Uri.parse("scheme://user:pass@host/path/?q#fr");
  url2 = Uri.parse("scheme://user:pass@replaced/path/?q#fr");
  Expect.equals(url2, url1.replace(host: "REPLACED"));

  url1 = Uri.parse("scheme://user:pass@host/path/?q#fr");
  url2 = Uri.parse("scheme://user:pass@/path/?q#fr");
  Expect.equals(url2, url1.replace(host: ""));
}
