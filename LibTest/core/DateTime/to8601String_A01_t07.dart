 ...
 * @description Check thatIf microsecond equals 0, then this part is omitted.
 * @author sgrekhov@unipro.ru
 */
import "../../../Utils/expect.dart";

main() {
  var date = new DateTime.fromMillisecondsSinceEpoch(1, isUtc: true);
  Expect.equals("1970-01-01T00:00:00.001Z", date.toIso8601String());
}
