...
test(Iterable create([Iterable content])) {
  Expect.isTrue(create([0, 1, 2, 3]).any((e) => e > 1 && e < 3));
  Expect.isFalse(create([1, 2, 3]).any((e) => e < 0));
  Expect.isTrue(create([null]).any((e) => true));
  Expect.isFalse(create([null]).any((e) => false));
