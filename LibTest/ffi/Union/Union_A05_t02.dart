...
void main() {
  ...
  try {
    ...
    Expect.equals(0x3333, (u2 + 1).ref.x);
    Expect.equals(0x2222, (u2 + 2).ref.x);
    Expect.equals(0x1111, (u2 + 3).ref.x);

    Pointer<U3> u3 = new Pointer.fromAddress(u1.address);
    Expect.equals(0x4444, u3.ref.x);
    Expect.equals(0x3333, (u3 + 1).ref.x);
    Expect.equals(0x2222, (u3 + 2).ref.x);
    Expect.equals(0x1111, (u3 + 3).ref.x);
