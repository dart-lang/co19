...
main() {
  ...
  Expect.isFalse(iterable.every((element) { return false; }));
  Expect.isFalse(iterable.every((element) { return element < 0; }));
  Expect.isFalse(iterable.every((element) { return element > 4; }));
}
