...
void check(IterableMixin iterable, bool test(dynamic element)) {
...
main() {
  ...
  check(iterable, (element) => element == 1);
  check(iterable, (element) => true);
  check(iterable, (element) => false);
  check(iterable, (element) => element > 4);
  check(iterable, (element) => element < 4);
  check(iterable, (element) => element == 4);
}
