 ...
 * the list and [start] index is clearly set to [0]
...
main() {
  ...
  Expect.equals(-1, a.indexOf(3.14, 0));
  Expect.equals(-1, a.indexOf(null, 0));
  Expect.equals(-1, a.indexOf(a, 0));
  Expect.equals(-1, a.indexOf(8, 0));
}
