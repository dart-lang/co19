...
<ul id="console"></ul>
  ...
  log(str)
  {
    ...
    li.append(new Text(str));
    var console = document.getElementById("console");
    console.append(li);
  }

  escape(x) => Uri.encodeComponent(x);

  assertEqual(test_name, actual, expected)
  {
    if (actual != expected) {
      log("==================================");
      ...
      if (actual.length != expected.length) {
        log("length !=" + "; actual.length.toString(): " + actual.length.toString() + "; expected.length.toString(): " + expected.length.toString());
        ...
        for (var i=0; i<length; ++i) {
          log("i: " + i.toString() + "; actual: " + actual[i] + "; expected: " + expected[i]);
  ...
  expandRangeString(range, startId, startOffset, endId, endOffset, expandUnit, firstChild)
  {
