...
const List<String> expected = [
  ...
  '$shortFile:$LINE_A:34', // on ')'
  '$shortFile:$LINE_F:10', // on '='
  '$shortFile:$LINE_F:12', // on 'C2'
  '$shortFile:$LINE_B:22', // on 'v2'
  '$shortFile:$LINE_B:24', // on ')'
  '$shortFile:$LINE_G:10', // on '='
  '$shortFile:$LINE_G:12', // on 'C3'
  '$shortFile:$LINE_C:26', // on 'v2'
  '$shortFile:$LINE_D:5', // on 'v3'
];
...
final tests = <IsolateTest>[
  ...
  (VmService service, IsolateRef isolateRef) async {
    ...
    response =
        await service.evaluateInFrame(isolateId, 0, 'C3(5, 6).v3')
            as InstanceRef;
