...
///
/// @description Checks that class `C<T1,...,Tn>` is an abstract (cannot be
/// instantiated by `new`) if there is an `abstract` identifier, even if all
/// classes in a mixin application are not abstract
