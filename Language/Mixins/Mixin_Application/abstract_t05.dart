 ...
 * @description Checks that class C is not abctract (can be instantiated by
 * new) if there are no abstract identifier but all clases in mixin
 * application are abstract and have abstract methods
 * @static-warning
