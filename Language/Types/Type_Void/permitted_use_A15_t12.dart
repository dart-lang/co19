...
///
/// @description Checks that in a `⟨spreadElement⟩` `S` of the form `...?e` and
/// a static type that implements `Iterable<T>`, `Map<T, S>`, or `Map<S, T>`
/// where `T` is `void`, `S` will have `void` as its element, key, and value
/// type.
