...
typedef List<Map<int, List<List<int>>>>
        t13(int x, v, [int? y, List? z, Map<String, List<int>>? m]);
...
f4(x) {}
int f5(x) => 42;
String f6(x, int y) => "Lily was here";
t1? f7(t2 x, t3 y) {}
t7? f8(t7 x, [t7? y]) {}
void f9([x]) {}
int f10([int? x]) => 0;
...
List<Map<int, List<List<int>>>> f13(int x, v, [int? y, List? z, Map<String, List<int>>? m]) => [];
t13? f14(t13 a, [t13? b]) {}
