...
class C1 {
  int x = 0;
  static void Function() y1 = () {print(this.x);};
//                                      ^^^^
// [analyzer] unspecified
// [cfe] unspecified

  static int Function() y2 = () => this.x;
//                                 ^^^^
// [analyzer] unspecified
// [cfe] unspecified

  static int Function(String s) y3 = (String s) {return this.x;};
//                                                      ^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
...
class C2 {
  int x = 0;
  static late void Function() y1 = () {print(this.x);};
//                                           ^^^^
// [analyzer] unspecified
// [cfe] unspecified

  static late int Function() y2 = () => this.x;
//                                      ^^^^
// [analyzer] unspecified
// [cfe] unspecified

  static late int Function(String s) y3 = (String s) {return this.x;};
//                                                           ^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
