 ...
 * of the implicit interface of class J if I is listed in the implements
 * clause of J.
 * @description Checks that a type listed in the implements clause of another is its supertype.
 * @author iefremov
 * @reviewer rodionov
