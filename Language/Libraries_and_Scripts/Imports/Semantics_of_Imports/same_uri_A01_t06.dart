...
import 'same_uri_lib5.dart';
import 'same_uri_lib6.dart';

main() async {
  await lib5Load();
  Expect.equals(0, lib5Increment);
  Expect.equals(1, lib5Counter);
  await lib6Load();
  Expect.equals(1, lib6Increment);
  Expect.equals(2, lib6Counter);
}
