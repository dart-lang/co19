 ...
 *   
 * @description Checks that it is possible to have two libraries that import and re-export
...
import "namespace_changes_t22_lib.dart";

main() {
  Expect.equals("Endless loop", endless_loop);
}
