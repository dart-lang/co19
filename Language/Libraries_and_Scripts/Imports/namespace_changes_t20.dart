 ...
 *   
 * @description Checks that non-private local declarations of an imported library shadow
 * those from other libraries it re-exports if they have identical names.
 * @author rodionov
 * @reviewer kaigorodov
 */
import "../../../Utils/expect.dart";

import "namespace_changes_t20_lib.dart";

main() {
  new aFoo();
  Expect.equals(42, aFunc);
