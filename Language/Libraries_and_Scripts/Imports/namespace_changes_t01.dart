 ...
 *
 * @description Checks that if the specified prefix is an empty string, and no
 * show/hide combinators are used, each non-private top level declaration d of
 * B is added to the scope of A.
 * @author vasya
 * @reviewer msyabro
 * @reviewer rodionov
 */
