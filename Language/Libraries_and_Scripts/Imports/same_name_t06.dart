 ...
 * checked mode if two different libraries introduce the same name N to the top
 * level scope of L and L uses it as a type parameter bound because N is treated
 * as dynamic.
 * @static-warning
 * @author kaigorodov
 */
