 ...
 * scope of S. 
 * @description Checks that a name in the scope of a block statement can hide a name from a
 * lexically enclosing scope and that does not produce a static warning.
 * @author msyabro
 * @reviewer iefremov
 */
