 ...
 * and o21... o2n respectively. Iff identical(o1i, o2i) for 1 <= i <= n and V = U then
 * identical(list1, list2).
 * @description Checks that constant lists with different elements or type arguments are not
 * identical.
 * @author msyabro
 * @reviewer kaigorodov
 */
