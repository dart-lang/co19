 ...
 * @description Check that if library object is an instance but not a constant
 * type literal and result of method lookup forwards to a static getter, then
 * lookup fails
...
main() {
  var o = new lib.C();
  Expect.throws(() {o.sg;}, (e) => e is NoSuchMethodError);
}
