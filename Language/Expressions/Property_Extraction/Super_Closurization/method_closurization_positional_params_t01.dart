 ...
 * m(r1, . . . , rn , [p1 = d1, . . . , pk = dk]) on the superclass is
...
class C extends A {
  void test() {
    ...
    var f2 = (int r1, int r2, double r3, [p1 = 2, p2 = -3, p3 = -7]) {
      return super.m(r1, r2, r3, p1, p2, p3);
    };

    Expect.equals(f1(1, 2, 3.2, 4, 5, 6), f2(1, 2, 3.2, 4, 5, 6));
    Expect.equals(f1(2, 3, 8.5), f2(2, 3, 8.5));
    Expect.equals(f1(-1, 3, 9.1, 4), f2(-1, 3, 9.1, 4));
    Expect.equals(f1(-1, 3, 9.1, 4, 5), f2(-1, 3, 9.1, 4, 5));
  }
}
