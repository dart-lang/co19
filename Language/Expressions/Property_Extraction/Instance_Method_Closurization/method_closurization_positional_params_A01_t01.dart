...
class C {
  double m(double r1, [p1 = 1, num p2 = 2.1, p3]) => r1 * p1 * p2 * (p3 ?? 1);
}

mixin M {
  double m(double r1, [p1 = 2, num p2 = 2.2, p3]) => r1 * p1 * p2 * (p3 ?? 1);
}
...
enum E {
  ...
  double m(double r1, [p1 = 3, num p2 = 2.3, p3]) => r1 * p1 * p2 * (p3 ?? 1);
}

class A {}

extension Ext on A {
  double m(double r1, [p1 = 4, num p2 = 2.4, p3]) => r1 * p1 * p2 * (p3 ?? 1);
}

extension type ET(int _) {
  double m(double r1, [p1 = 5, num p2 = 2.5, p3]) => r1 * p1 * p2 * (p3 ?? 1);
}
