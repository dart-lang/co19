 ...
 * getter m in S with respect to L. The body of f is executed with this bound
 * to the current value of this. The value of i is the result returned by the
 * call to the getter function.
 * @description Check that the body of getter f is executed with this bound to
 * the current value of this. Superclass is defined in a library
