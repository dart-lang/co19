...
/// constant if `e2` and `e3` are constants but `e1` is not potentially constant
/// @author sgrekhov22@gmail.com

class C {
  static bool e1 = 2 > 1;   // Not potentially constant
...
main() {
  const c = C.e1 ? C.one : C.two;
//          ^^^^
// [analyzer] unspecified
// [cfe] unspecified

  const m = M.e1 ? M.one : M.two;
//          ^^^^
// [analyzer] unspecified
// [cfe] unspecified

  const e = E.e1 ? E.one : E.two;
//          ^^^^
// [analyzer] unspecified
// [cfe] unspecified

  const a = Ext.e1 ? Ext.one : Ext.two;
//          ^^^^^^
// [analyzer] unspecified
// [cfe] unspecified

  const et = ET.e1 ? ET.one : ET.two;
//           ^^^^^
// [analyzer] unspecified
// [cfe] unspecified
}
