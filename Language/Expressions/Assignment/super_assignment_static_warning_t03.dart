 ...
 * @description Checks that it is no static type warning if Sstatic does not
 * have an accessible instance setter named v = but annotated with a constant
 * identical to the constant @proxy defined in dart:core
 * @static-clean
 * issue 15467
