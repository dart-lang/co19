...
class C extends A {
  test() {
    Expect.equals(1, super[1] = 1); /// static type warning
    Expect.equals(2, super[false] = 2); /// static type warning
    Expect.equals("12", super["foo"] = "1" "2"); /// static type warning
    Expect.equals(true, super[-1.11] = 1 < 2); /// static type warning
  }
}
main() {
  C c = new C();
