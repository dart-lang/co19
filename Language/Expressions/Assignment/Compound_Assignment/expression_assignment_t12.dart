 ...
 * to ((x) => x.v = x.v >>> e2)(e1) where x is a variable that is not used in
 * e2.
...
check(operand1, operand2) {
  ...
  Expect.equals(1, a.getterInvocation); //checks that getter was invoked one time only
  Expect.equals(1, a.setterInvocation); //checks that setter was invoked one time only
